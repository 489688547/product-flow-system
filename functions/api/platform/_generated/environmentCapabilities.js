...
const environmentCapabilities = {
  ...
  "capabilities": [
    ...
    },
    {
      ...
      "name": "公司网页数据采集运行时",
      "description": "公司 Mac 通过日常 Chrome 的内置 MV3 插件、本机 loopback 执行器、固定 provider adapter、日计划和任务租约采集已验证网页数据；销售异常可按店铺和业务日期幂等排队，登录恢复后由授权用户人工重排。这是当前快麦与抖店官方报表采集的共享运行时，并可在服务端与公司 Mac 双开关显式启用后运行版本化实验模板；实验结果只允许 untrusted 或 validated，默认不进入正式经营事实。",
      "platforms": [
        "cloudflare-pages",
        "cloudflare-d1",
        "kuaimai",
