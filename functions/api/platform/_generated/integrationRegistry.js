...
const integrationRegistry = {
  ...
  "platforms": [
    ...
    },
    {
      ...
      "name": "快麦开放平台",
      "status": "integrating",
      "summary": "开放平台按订单创建时间拉取有限订单和商品数据，并对疑似截断的最新销售日进行幂等完整分页补拉；历史及日常完整数据仍由公司 Mac 使用快麦后台官方导出，原始文件留在本机，D1 保存通用任务、修复记录、归档清单和业务投影。",
      "capabilities": [
        "官方文件历史补数",
        "公司 Mac 每日网页采集",
        "订单创建时间口径",
      ...
      "relations": [
        ...
        },
        {
          ...
          "description": "官方文件是当前快麦全历史补数和日常完整数据的主通道，并校准销售事实及补齐 API 未返回的商品字段。"
        }
      ]
    },
    {
