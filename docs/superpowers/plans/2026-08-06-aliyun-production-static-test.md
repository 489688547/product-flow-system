...
- [ ] **Step 3: Implement prepare-runtime-build**
...
- [ ] **Step 4: Remove only generated release files**
...
- [ ] **Step 5: Verify a real static test build**
...
- [ ] **Step 6: Commit the exact rename and deletion set**
