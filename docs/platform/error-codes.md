...
| 分类 | 错误码 | 可自助重试 |
|---|---|---|
| 页面交互未生效 | `DOUYIN_DATE_RANGE_NOT_APPLIED`、`DOUYIN_DATE_CONTROL_MISSING`、`KUAIMAI_TIME_RANGE_NOT_APPLIED`、`KUAIMAI_SALES_EXPORT_CONFIRM_MISSING`、`DOUYIN_OFFICIAL_REPORT_BUTTON_MISSING`、`KUAIMAI_API_REQUEST_FAILED`、`KUAIMAI_API_TOTAL_MISMATCH` | 是 |
