...
- [x] **Step 1: Replace old navigation assertions with failing merged-navigation assertions**
...
- [x] **Step 3: Implement cockpit hierarchy**
...
- [x] **Step 4: Implement Phase 0 routes and explicit future-phase states**
...
- [x] **Step 5: Add responsive and focus CSS**
...
Actual verification: `node --test react-tests/supply-chain-ui.test.mjs react-tests/goods-flow-ui.test.mjs react-tests/goods-flow-state.test.mjs` (17 tests passed); focused ESLint, production build and `git diff --check` passed. The cockpit has exactly three headline metrics, truthful missing-data states and responsive table overflow without vertical Chinese headers.
