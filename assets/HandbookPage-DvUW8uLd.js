import{j as n,r as p}from"./react-vendor-CgER1fZB.js";import{B as ln,M as cn,a as pn,r as dn}from"./markdown-vendor-BtF6cZKv.js";import{P as un}from"./PageHeader-BF8LF3r1.js";import{k as q}from"./index-svmxita5.js";import{T as O,ai as y,X as V,a9 as mn,a7 as _n,ag as An,ab as Q,D as z,aK as $,b as J,R as In,aO as B,av as fn,c as gn,f as En,O as K}from"./icons-vendor-BKfNGA7D.js";const X=[{id:"handbook",label:"使用手册"},{id:"product",label:"产品与设计"},{id:"platform",label:"平台能力"}],b=a=>String(a??"").replace(/\s+/g," ").trim(),x=a=>/^#{1,6}\s|^(```|~~~|>|[-*+]\s|\d+[.)]\s|\|)/.test(a),G=a=>b(a.replace(/!\[([^\]]*)\]\([^)]*\)/g,"$1").replace(/\[([^\]]+)\]\([^)]*\)/g,"$1").replace(/[`*_~]/g,"")),vn=a=>{const e=String(a??"").match(/^#\s+(.+?)\s*#*\s*$/m);return e?G(e[1]):"未命名说明"},hn=a=>{const e=String(a??"").split(/\r?\n/);for(let s=0;s<e.length;s+=1){const t=e[s].trim();if(!t||x(t))continue;const l=[t];for(;e[s+1]?.trim()&&!x(e[s+1].trim());)l.push(e[s+1].trim()),s+=1;return G(l.join(" "))}return"暂无摘要"};function w(a){const e=String(a.content??"");return{...a,content:e,title:b(a.title)||vn(e),summary:b(a.summary)||hn(e)}}function Dn(a,{query:e="",category:s="all"}={}){const t=b(e).toLocaleLowerCase("zh-CN");return a.filter(l=>s&&s!=="all"&&l.category!==s?!1:t?[l.title,l.summary,l.content].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function Tn(a,e,s){return a.length?a.find(t=>t.slug===e)??a.find(t=>t.slug===s)??a[0]:null}function Nn(a){const e=new ln,s=[],t=/^(#{2,3})\s+(.+?)\s*#*\s*$/gm;let l;for(;(l=t.exec(String(a??"")))!==null;){const o=G(l[2]);s.push({level:l[1].length,title:o,id:e.slug(o)})}return s}function Pn(a){const e=String(a??""),s=e.split(/\r?\n/);let t=0;for(;t<s.length&&!s[t].trim();)t+=1;if(!/^#\s+/.test(s[t]?.trim()??""))return e;for(t+=1;t<s.length&&!s[t].trim();)t+=1;if(s[t]?.trim()&&!x(s[t].trim())){for(;t<s.length&&s[t].trim();)t+=1;for(;t<s.length&&!s[t].trim();)t+=1}return s.slice(t).join(`
`).trim()}const Rn=a=>/^https?:\/\//i.test(a??"");function Sn({content:a}){return n.jsx("div",{className:"handbook-markdown",children:n.jsx(cn,{remarkPlugins:[dn],rehypePlugins:[pn],components:{h1:()=>null,a:({href:e,children:s,...t})=>Rn(e)?n.jsx("a",{...t,href:e,target:"_blank",rel:"noreferrer",children:s}):n.jsx("a",{...t,href:e,children:s}),table:({children:e,...s})=>n.jsx("div",{className:"handbook-table-wrap",children:n.jsx("table",{...s,children:e})})},children:a})})}const Cn=`# 公司经营功能使用说明
...
- 所有已登录员工可以查看平台连接的脱敏状态；只有最高权限管理员可以验证、保存或停用公司级钉钉、快麦和灵算连接，服务端必须再次校验权限。灵算保险箱值仅可由最高权限管理员在 15 分钟内新会话中填写用途和精确确认语后临时查看；总经办普通成员、环境变量来源和超过频率限制的请求均拒绝。
...
所有已登录员工可以看到安全状态和处理入口，只有对应权限用户可以修改数据源，只有最高权限管理员可以维护钉钉、快麦等公司级平台连接。保存前必须先验证候选配置，普通页面和接口不展示已保存的密钥；灵算保险箱凭据仅允许最高权限管理员在近期登录、用途、确认语、限流、禁缓存和审计全部满足时临时查看，环境变量回退永不回显。尚未完成真实接入的平台只显示规划状态，不伪装成可配置能力。公司级连接凭据与业务同步实例可以在同一详情中展示，但继续使用各自的服务端权限、接口和安全存储，不在浏览器中持久化或跨功能混存。
...
最高权限账号可以在设置中为当前浏览器切换“正式数据库”和“展示数据库”。普通业务页面保持原样，不显示展示标签；普通员工默认只使用正式数据库，也看不到切换设置。展示数据库是独立 D1，由正式业务数据受控更新，销售数量、订单量和金额类可加总事实扩大为两倍，退款率、毛利率和客单价等比例或均值从基础事实重新计算并保持原口径。

展示数据库只有一份，更新期间暂不可用；更新失败时不读取正式库兜底。快麦、ERP 文件和网页采集等真实读取能力保留，结果按当前环境写入；钉钉待办、日历、审批等会改变外部平台状态的动作在展示环境模拟成功，不调用真实平台。平台凭证、登录会话、最高权限、采集控制任务、AI Provider 配置和 Token 审计始终留在正式控制库。展示数据库不替代本地沙箱，试验性数据仍只能写沙箱。
...
数据中心「AI 大模型」默认查看最近 30 天，可快速切换 7、30、90 天或确认自定义日期。页面只按 App、功能、模型、Skill 和数据环境展示公司调用次数、Token、成功率、规则降级和最近使用，不提供员工排行、个人下钻、提示词或回答内容。模型与安全设置位于页面底部并默认收起；公司级灵算连接凭据直接在该设置内通过平台连接保险箱保存、验证、替换、停用和受控临时查看，不再依赖已经取消的数据接入入口。
...
年度时间条主体只显示可读日期：同月使用“7月8日—28日”，跨月使用“7月22日—8月25日”；“开发至上线”保留在图例和无障碍说明。具备编辑权限时，拖动中部移动整段，拖动两端调整对应日期，移动达到 4px 才视为拖动；预览期间不保存，松开后只提交一次。边缘缩放限制在当前年度且不得交叉，中部移动可跨年但结果必须与当前年度相交。点击、Enter 或 Space 继续打开精确日期弹窗，触控保留纵向滚动；时间轴最后一行、纵向网格和面板圆角必须形成完整收口。
...
数据质量是同步结果的一部分，不单独占用左侧入口。“数据同步”按质量摘要、异常恢复、执行记录、待处理数据问题的顺序单列展示；页面标题只出现一次，不增加页内 Tab，也不把运行记录和质量问题合并成一张字段含义不一致的表。历史质量链接兼容进入数据同步。
...
总览的“经营趋势”和“平台分布”只表达已确认本期范围的 GMV 销售事实。趋势必须保留范围内每个自然日；没有事实的日期保留日期标签但不画零值柱，并明确显示“暂无销售数据”。趋势柱悬停或键盘聚焦时，日期、GMV、销售数量、毛利率及各平台 GMV 显示在图表外的固定详情区，不得覆盖柱体或截获鼠标。总览不再单设“数据健康”面板，页面右上角显示最新事实日期和异常数量，点击进入数据同步。

截止昨天的目标业务日完全缺失，或最新事实日的 GMV 与销量同时低于此前有效日中位数的 25% 时，右上角直接显示“去处理”，不得自动调用未打通的快麦开放平台 API；按缺失或异常日期幂等排队一次公司 Mac Chrome 采集任务。点击后进入数据同步并聚焦对应异常，读取公司 Mac 的 Chrome 采集设备和任务状态；登录、验证码、页面结构变化、失败、离线和完成必须使用不同文案。登录恢复后以“我已登录，重新触发”为主操作，明确任务将在插件下一轮轮询时领取，并始终保留“检查 Chrome 采集”和“导入官方销售报表”两个真实兜底入口。
...
商品主数据默认以档案治理和异常处理为主，经营数据作为判断商品状态的上下文。状态带优先展示商品、库存单位、有销量覆盖、档案待完善和销售未匹配；未匹配销售不猜测归属，必须提供前往数据同步的处理入口。平台和日期先形成查询草稿，只有明确点击“查询数据”后才请求服务端聚合。

主表保持一行一个商品和稳定行高，只展示商品身份、SKU 摘要、类型/组成状态、分类品牌、销量/净销售额、权限内成本和状态操作。全部 SKU、组合组成、平台拆分、跨 App 关联与来源时间进入只读商品详情弹窗；任务视图按全部、待完善、组合、未售和未关联组织，不另建商品销售分析页。
...
`,M="handbook/getting-started",Te=Object.assign({"../../../docs/handbook/company-platform.md":Cn,"../../../docs/handbook/faq.md":On,"../../../docs/handbook/getting-started.md":jn,"../../../docs/handbook/product-lifecycle.md":bn,"../../../docs/platform/api-catalog.md":Ln,"../../../docs/platform/architecture.md":kn,"../../../docs/platform/browser-market-collection.md":yn,"../../../docs/platform/components.md":xn,"../../../docs/platform/data-acquisition.md":wn,"../../../docs/platform/environment-parity-skill.md":Mn,"../../../docs/platform/environment-readiness.md":Un,"../../../docs/platform/error-codes.md":Vn,"../../../docs/platform/external-platform-map.md":Gn,"../../../docs/platform/integrations.md":Fn,"../../../docs/platform/middleware.md":Bn,"../../../docs/product/core-workflows.md":Kn,"../../../docs/product/data-definitions.md":Hn,"../../../docs/product/roles-and-permissions.md":Wn,"../../../docs/superpowers/specs/2026-07-11-permission-settings-design.md":Yn,"../../../docs/superpowers/specs/2026-07-11-task-category-actions-design.md":qn,"../../../docs/superpowers/specs/2026-07-11-workflow-task-templates-design.md":Qn,"../../../docs/superpowers/specs/2026-07-13-dashboard-department-todos-design.md":zn,"../../../docs/superpowers/specs/2026-07-13-demand-created-at-design.md":$n,"../../../docs/superpowers/specs/2026-07-13-dingtalk-web-login-design.md":Jn,"../../../docs/superpowers/specs/2026-07-13-platform-sales-sorting-design.md":Xn,"../../../docs/superpowers/specs/2026-07-15-product-planning-design.md":Zn,"../../../docs/superpowers/specs/2026-07-15-product-progress-schedule-design.md":ne,"../../../docs/superpowers/specs/2026-07-16-company-strategy-execution-platform-design.md":ee,"../../../docs/superpowers/specs/2026-07-16-executive-personal-todo-dingtalk-sync-design.md":ae,"../../../docs/superpowers/specs/2026-07-16-strategy-department-incentive-monthly-report-design.md":se,"../../../docs/superpowers/specs/2026-07-17-dingtalk-group-executor-selection-design.md":te,"../../../docs/superpowers/specs/2026-07-17-dingtalk-todo-recovery-deliverable-crud-design.md":ie,"../../../docs/superpowers/specs/2026-07-17-integration-routing-platform-map-design.md":oe,"../../../docs/superpowers/specs/2026-07-17-planning-card-progress-navigation-design.md":re,"../../../docs/superpowers/specs/2026-07-17-platform-handbook-design.md":le,"../../../docs/superpowers/specs/2026-07-17-product-grading-boundaries-design.md":ce,"../../../docs/superpowers/specs/2026-07-17-product-ownership-visibility-design.md":pe,"../../../docs/superpowers/specs/2026-07-17-strategy-crud-design.md":de,"../../../docs/superpowers/specs/2026-07-17-strategy-result-commitment-drilldown-design.md":ue,"../../../docs/superpowers/specs/2026-07-17-strategy-rule-strip-removal-design.md":me,"../../../docs/superpowers/specs/2026-07-17-supply-chain-left-navigation-design.md":_e,"../../../docs/superpowers/specs/2026-07-17-supply-chain-management-app-design.md":Ae,"../../../docs/superpowers/specs/2026-07-17-supply-chain-real-data-design.md":Ie,"../../../docs/superpowers/specs/2026-07-18-data-center-app-design.md":fe,"../../../docs/superpowers/specs/2026-07-19-collapsible-app-navigation-design.md":ge,"../../../docs/superpowers/specs/2026-07-20-connector-configuration-simplification-design.md":Ee,"../../../docs/superpowers/specs/2026-07-20-navigation-product-catalog-load-fix-design.md":ve}),H={handbook:0,product:1,platform:2},W={guide:0,product:0,design:1,specification:2,platform:0},U="2026-07-17",Z=a=>a.split("/").pop().replace(/\.md$/,""),Ne=a=>a.match(/^(\d{4}-\d{2}-\d{2})-/)?.[1]??U,Pe=a=>{const e=Z(a);return a.includes("/docs/handbook/")?{slug:`handbook/${e}`,category:"handbook",kind:"guide"}:a.includes("/docs/product/")?{slug:`product/${e}`,category:"product",kind:"product"}:a.includes("/docs/platform/")?{slug:`platform/${e}`,category:"platform",kind:"platform"}:{slug:`product/specs/${e}`,category:"product",kind:"specification"}},Re=Object.entries(Te).map(([a,e])=>{const s=Pe(a);return w({...s,updatedAt:Ne(Z(a)),content:e})}),Se=[w({slug:"product/product",category:"product",kind:"product",updatedAt:U,content:he}),w({slug:"product/design",category:"product",kind:"design",updatedAt:U,content:De})],k=[...Re,...Se].sort((a,e)=>(a.slug===M?-1:e.slug===M?1:0)||H[a.category]-H[e.category]||W[a.kind]-W[e.kind]||a.title.localeCompare(e.title,"zh-CN")),Ce=JSON.parse('[{"id":"dingtalk","name":"钉钉开放平台","status":"connected","summary":"承载登录、组织通讯录、待办、群聊、日历、文档、供应链文件快照和钉钉内嵌工作台能力。","capabilities":["身份登录","组织通讯录","待办任务","群聊与成员","日历","文档读取","采购与付款审批同步","供应链文件快照","内嵌工作台","平台连接配置","展示环境外部写模拟"],"businessQuestions":["登录或免登失败","找不到人员或部门","待办未创建或未同步","本地如何执行真实待办与日历动作","展示数据库为什么不发送真实钉钉动作","群成员选择异常","供应链文件快照未导入","钉钉 WebView 行为异常"],"keywords":["钉钉","DingTalk","免登","待办","通讯录","群聊","开放平台"],"codePaths":["functions/api/dingtalk/**","functions/api/auth/dingtalk/**","functions/api/supply-chain/approvals/sync.js","functions/api/platform/v1/collaboration-items/**/dingtalk.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/externalActionMode.js","functions/api/platform/_shared/displayExternalActionAdapter.js","src/state/dingtalk*.js","src/features/**/DingTalk*.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","scripts/import-dingtalk-supply-inventory.mjs","scripts/lib/dingtalkSupplyInventory.mjs","server.mjs"],"envVars":["DINGTALK_APP_KEY","DINGTALK_APP_SECRET","DINGTALK_CORP_ID","DINGTALK_TOKEN_ENCRYPTION_KEY"],"domains":["open.dingtalk.com","api.dingtalk.com","oapi.dingtalk.com"],"apiRoutes":["/api/dingtalk/","/api/auth/dingtalk/","/api/supply-chain/approvals/sync","/api/platform/v1/collaboration-items/:id/dingtalk","/api/platform/v1/platform-connections"],"publicDocs":[{"label":"钉钉开放平台能力中心","url":"https://open.dingtalk.com/"}],"evidence":["functions/api/dingtalk/","functions/api/auth/dingtalk/","functions/api/supply-chain/approvals/sync.js","functions/api/platform/v1/collaboration-items/[id]/dingtalk.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/externalActionMode.js","functions/api/platform/_shared/displayExternalActionAdapter.js","src/features/data-center/PlatformConnectionsWorkspace.jsx","scripts/import-dingtalk-supply-inventory.mjs","scripts/lib/dingtalkSupplyInventory.mjs"],"relations":[{"platformId":"cloudflare-d1","type":"stores-session-and-org-data","description":"登录会话、用户令牌与组织同步结果使用 D1 持久化。"},{"platformId":"cloudflare-pages","type":"hosts-callbacks","description":"Pages Functions 承载登录回调和开放平台 API 适配器。"}]},{"id":"kuaimai","name":"快麦开放平台","status":"integrating","summary":"快麦开放平台 API 当前未打通且产品不调用；公司 Mac 使用 Chrome 插件驱动快麦后台官方导出，官方文件负责完整销售、商品和历史补数，原始文件留在本机，D1 保存通用任务、归档清单和业务投影。","capabilities":["官方文件历史补数","公司 Mac 每日网页采集","订单创建时间口径","异常日 Chrome 自动排队与人工重排","本地原始文件归档","通用任务租约与游标","最小索引幂等落库","导入批次与异常审计","固定范围采集令牌","销售日聚合"],"businessQuestions":["快麦历史数据补录","三个月内订单与归档订单如何完整导出","Chrome 采集失败","订单同步缺失","最新销售日疑似截断如何通过 Chrome 或官方文件修复","ERP 商品或库存单位编码未同步","组合商品比例未同步","库存和出入库数据如何补录","销售数据未落库","本地如何触发真实同步","月度数据校准","快麦开放平台 API 未打通"],"keywords":["快麦","Kuaimai","订单同步","销售数据","ERP","开放平台"],"codePaths":["functions/api/kuaimai/**","functions/api/platform/v1/data-services/sales-repair.js","functions/api/platform/v1/data-services/_shared/salesRepair.js","functions/api/platform/v1/erp-collection/**","functions/api/platform/v1/web-collection/**","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/**","functions/api/platform/v1/goods-flow/**","functions/api/sales.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","src/domain/kuaimaiErpCollection.js","src/domain/webCollection.js","src/domain/dataSyncRecovery.js","src/domain/productCatalog.js","src/domain/productCatalogGraph.js","src/domain/productCatalogSales.js","src/state/ProductCatalogProvider.jsx","src/state/productCatalogApi.js","src/state/webCollectionApi.js","src/features/data-center/DataCenterAppPage.jsx","src/features/data-center/DataGovernanceWorkspaces.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","src/features/settings/KuaimaiSyncSettings.jsx","src/state/salesStore.js","chrome-extension/company-data-collector/**","scripts/kuaimai-erp-collector/**","scripts/web-data-collector/**",".agents/skills/kuaimai-erp-data-collection/**","migrations/0006_product_catalog_components.sql","migrations/0007_kuaimai_erp_collection.sql","migrations/0008_kuaimai_erp_local_archives.sql","migrations/0009_web_collection.sql","docs/features/kuaimai-erp-history/**","docs/features/kuaimai-erp-local-archive/**","docs/features/company-web-data-collector/**","docs/features/data-warning-recovery/**","server.mjs"],"envVars":["KUAIMAI_APP_KEY","KUAIMAI_APP_SECRET","KUAIMAI_ACCESS_TOKEN","KUAIMAI_REFRESH_TOKEN"],"domains":["open.kuaimai.com","api.kuaimai.com","scm.superboss.cc","erp.superboss.cc","erpb.superboss.cc"],"apiRoutes":["/api/kuaimai/","/api/sales","/api/platform/v1/data-services/sales-repair","/api/platform/v1/erp-collection/ingest","/api/platform/v1/erp-collection/archives","/api/platform/v1/erp-collection/runners","/api/platform/v1/web-collection/jobs","/api/platform/v1/web-collection/runners","/api/platform/v1/platform-connections","/api/platform/v1/product-catalog","/api/platform/v1/product-catalog/import","/api/platform/v1/product-catalog/sync/kuaimai"],"publicDocs":[{"label":"快麦开放平台 API 文档","url":"https://open.kuaimai.com/docs/"}],"evidence":["functions/api/kuaimai/","functions/api/platform/v1/data-services/sales-repair.js","functions/api/platform/v1/data-services/_shared/salesRepair.js","functions/api/platform/v1/erp-collection/ingest.js","functions/api/platform/v1/web-collection/jobs.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/product-catalog/sync/kuaimai.js","functions/api/platform/v1/product-catalog/_shared/sales.js","functions/api/platform/v1/goods-flow/imports.js","src/domain/kuaimaiErpCollection.js","src/domain/webCollection.js","src/domain/dataSyncRecovery.js","src/domain/productCatalog.js","src/domain/productCatalogGraph.js","src/domain/productCatalogSales.js","src/state/webCollectionApi.js","src/features/data-center/DataCenterAppPage.jsx","src/features/data-center/DataGovernanceWorkspaces.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","src/features/settings/KuaimaiSyncSettings.jsx","chrome-extension/company-data-collector/manifest.json","chrome-extension/company-data-collector/providers/kuaimai.js","scripts/kuaimai-erp-collector/core.mjs","scripts/web-data-collector/",".agents/skills/kuaimai-erp-data-collection/SKILL.md","docs/platform/apis/sales-data-repair-v1.md","docs/platform/apis/erp-collection-v1.md","docs/platform/apis/web-collection-v1.md","docs/features/data-warning-recovery/prd.md","docs/features/kuaimai-erp-history/prd.md","migrations/0006_product_catalog_components.sql","migrations/0007_kuaimai_erp_collection.sql","migrations/0009_web_collection.sql"],"relations":[{"platformId":"cloudflare-d1","type":"stores-erp-source-records","description":"快麦任务、游标、归档清单、批次、共享商品目录、组合关系、最小索引和异常审计写入 D1；原始文件留在公司 Mac。"},{"platformId":"erp-file-import","type":"primary-current-channel","description":"Chrome 插件驱动的官方导出与人工官方文件是当前快麦历史、日常和完整口径的主通道；开放平台 API 暂不使用。"}]},{"id":"douyin-ecommerce","name":"抖音电商罗盘","status":"retired","summary":"店铺网页登录采集已退役；抖音店铺经营改为平台原始文件方向，当前等待真实文件样例。","capabilities":["原始文件方向","等待文件样例","旧凭证不可恢复销毁","历史审计保留"],"businessQuestions":["抖音原始文件样例","订单创建时间口径","文件字段识别","历史连接清理"],"keywords":["抖音电商","抖店","Douyin","原始文件","文件导入"],"codePaths":["src/domain/dataCenterConnectors.js","src/features/data-center/connections/**","functions/api/platform/v1/data-connections/**","functions/api/platform/_shared/credentialVaultStorage.js","migrations/0006_data_connections.sql"],"envVars":[],"domains":[],"apiRoutes":["/api/platform/v1/data-connections"],"publicDocs":[],"evidence":["docs/features/store-file-import-transition/prd.md","docs/features/store-file-import-transition/design.md","migrations/0006_data_connections.sql"],"relations":[{"platformId":"cloudflare-d1","type":"stores-cleanup-audit","description":"D1 保留无秘密审计和历史经营事实；旧店铺凭证密文与 IV 被清空。"},{"platformId":"cloudflare-pages","type":"hosts-retirement-api","description":"Pages Functions 承载旧连接只读与受控销毁接口。"},{"platformId":"erp-file-import","type":"planned-file-pattern","description":"店铺原始文件后续复用已验证的预览、确认和标准事实写入原则，但必须先取得真实样例。"},{"platformId":"kuaimai","type":"possible-overlap","description":"文件导入需区分快麦聚合订单与抖音店铺原始经营数据。"},{"platformId":"oceanengine-qianchuan","type":"commerce-to-advertising","description":"店铺经营数据与巨量投放数据分别采集并通过标准维度关联。"}]},{"id":"cloudflare-pages","name":"Cloudflare Pages","status":"connected","summary":"托管 React 应用与 Pages Functions，并提供生产和预览运行边界。","capabilities":["静态站点托管","Pages Functions","生产部署","预览环境","本地线上账号运行","回滚","环境就绪检查","正式与展示业务数据库路由","生产数据网关","凭证加密服务","加密平台连接","网页采集任务控制面","用户洞察共享 API","共享数据口径","销售异常后台修复","前端运行时故障恢复"],"businessQuestions":["构建或部署失败","生产页面与本地不一致","Functions 路由异常","预览环境配置缺失","测试环境与生产配置漂移","本地如何使用真实线上账号、数据与外部动作"],"keywords":["Cloudflare","Pages","Pages Functions","部署","生产环境"],"codePaths":["functions/**","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/data-standards/**","functions/api/platform/v1/_shared/dataStandards*.js","src/state/deploymentRecovery.js","src/state/resilientLocalStorage.js","src/state/applicationRecovery.js","src/ui/ApplicationErrorBoundary.jsx","scripts/prepare-pages-build.mjs","scripts/prepare-pages-release.mjs","scripts/check-deployed-readiness.mjs","cloudflare-entry.html","404.html","public/404.html","_redirects","wrangler.toml",".github/workflows/**"],"envVars":["PLATFORM_CREDENTIAL_MASTER_KEY","LOCAL_ONLINE_ACCOUNT_MODE","PRODUCTION_DATA_ACCESS_TOKEN","AI_ASSISTANT_ENABLED","LINGSUAN_API_KEY","LINGSUAN_ACTOR_AUTHORIZATION","VITE_DATA_CENTER_LEGACY_OVERVIEW_ROLLBACK"],"domains":["pages.dev","api.cloudflare.com","dash.cloudflare.com"],"apiRoutes":["/api/platform/v1/data-environment","/api/platform/v1/environment-readiness","/api/platform/v1/platform-connections","/api/platform/v1/credential-vault","/api/platform/v1/data-standards","/api/platform/v1/data-services/sales","/api/platform/v1/data-services/sales-repair","/api/platform/v1/web-collection/jobs","/api/platform/v1/web-collection/runners","/api/platform/v1/production-write-session","/api/platform/v1/production-data/","/api/platform/v1/user-insights","/api/platform/v1/user-insights/","/api/platform/v1/ai/"],"publicDocs":[{"label":"Cloudflare Pages 文档","url":"https://developers.cloudflare.com/pages/"},{"label":"Pages Functions 文档","url":"https://developers.cloudflare.com/pages/functions/"}],"evidence":["functions/","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/_shared/dataStandardsStorage.js","functions/api/platform/v1/data-services/sales.js","src/state/deploymentRecovery.js","src/state/resilientLocalStorage.js","src/ui/ApplicationErrorBoundary.jsx","docs/features/frontend-runtime-resilience/prd.md","docs/platform/architecture.md","docs/platform/apis/data-services-sales-v1.md","scripts/prepare-pages-build.mjs","scripts/prepare-pages-release.mjs","wrangler.toml"],"relations":[{"platformId":"cloudflare-d1","type":"binds","description":"Pages Functions 通过 PRODUCT_FLOW_DB 控制/正式绑定和独立 DEMO_FLOW_DB 展示业务绑定访问 D1。"}]},{"id":"cloudflare-d1","name":"Cloudflare D1","status":"connected","summary":"保存共享业务状态、平台数据、登录会话、组织数据、销售聚合、共享商品目录、用户洞察、货流事实、数据中心、加密凭证、店铺运营、人事绩效、跨 App 协同和 AI 安全元数据。","capabilities":["共享状态持久化","共享状态原子比较并写入","共享状态写前快照与审计","正式与展示业务数据库隔离","浏览器级数据环境授权","登录会话","组织数据","销售聚合","销售异常修复任务","共享商品目录","用户洞察标准事实","用户洞察部门规则","网页采集任务与游标","采集设备令牌哈希","货流事件与指标","平台配置","数据中心元数据","版本化数据口径与计算结果","加密凭证密文与审计","店铺运营记录","人事核心记录","绩效记录","跨 App 协同","AI Provider 元数据","AI 外发策略","AI 无内容审计","生产写入审计","写前快照","加密平台连接"],"businessQuestions":["数据只在本地可见","跨设备状态不同步","旧页面或旧分支覆盖产品进度","数据库绑定缺失","表结构或容量问题","用户洞察采集结果未落库","货流事实或指标未落库","人事数据表是否就绪","跨部门事项如何留痕","测试账号如何受控写生产数据","生产写入如何回滚"],"keywords":["D1","数据库","落库","PRODUCT_FLOW_DB","DEMO_FLOW_DB","展示数据库","持久化"],"codePaths":["functions/api/state.js","functions/api/platform.js","functions/api/supply-chain.js","functions/api/supply-chain/**","functions/api/platform/v1/goods-flow/**","functions/api/platform/v1/data-services/**","functions/api/sales.js","functions/api/data-center.js","functions/api/data-center/**","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/**","functions/api/ecommerce-operations.js","functions/api/ecommerce-operations/**","functions/api/performance-management.js","functions/api/performance-management/**","functions/api/hr-management/**","functions/api/auth/**","functions/api/dingtalk/org/**","functions/api/platform/_shared/productionDataAccess.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/credential*.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/v1/credential-vault.js","functions/api/platform/v1/credential-vault/**","functions/api/platform/v1/data-standards/**","functions/api/platform/v1/_shared/dataStandards*.js","functions/api/platform/v1/production-data/**","functions/api/platform/v1/collaboration-items/**","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/**","functions/api/platform/v1/ai/**","functions/api/platform/v1/_shared/collaborationStorage.js","migrations/**","migrations/0002_hr_management_core.sql","migrations/0003_product_catalog.sql","migrations/0003_platform_credentials.sql","migrations/0003_data_center_credentials.sql","migrations/0004_data_standards.sql","migrations/0005_user_insights.sql","migrations/0005_goods_flow_core.sql","migrations/0006_product_catalog_components.sql"],"envVars":["PRODUCT_FLOW_DB","DEMO_FLOW_DB"],"domains":["api.cloudflare.com","dash.cloudflare.com"],"apiRoutes":["/api/state","/api/platform","/api/supply-chain","/api/platform/v1/goods-flow/","/api/sales","/api/data-center","/api/platform/v1/data-services/sales","/api/platform/v1/data-services/sales-repair","/api/platform/v1/web-collection/jobs","/api/platform/v1/web-collection/runners","/api/platform/v1/product-catalog","/api/platform/v1/product-catalog/import","/api/platform/v1/product-catalog/sync/kuaimai","/api/ecommerce-operations","/api/performance-management","/api/hr-management","/api/platform/v1/data-environment","/api/platform/v1/environment-readiness","/api/platform/v1/platform-connections","/api/platform/v1/credential-vault","/api/platform/v1/data-standards","/api/platform/v1/production-write-session","/api/platform/v1/production-data/","/api/platform/v1/collaboration-items","/api/platform/v1/user-insights","/api/platform/v1/user-insights/","/api/platform/v1/ai/"],"publicDocs":[{"label":"Cloudflare D1 入门","url":"https://developers.cloudflare.com/d1/get-started/"},{"label":"Pages D1 绑定","url":"https://developers.cloudflare.com/pages/functions/bindings/"}],"evidence":["functions/api/state.js","functions/api/platform.js","functions/api/supply-chain.js","functions/api/supply-chain/","functions/api/platform/v1/goods-flow/","functions/api/platform/v1/data-services/sales.js","functions/api/sales.js","functions/api/data-center.js","functions/api/data-center/","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/","functions/api/ecommerce-operations.js","functions/api/ecommerce-operations/","functions/api/performance-management.js","functions/api/performance-management/","functions/api/hr-management/","functions/api/platform/_shared/productionDataAccess.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/credentialVaultStorage.js","functions/api/platform/_shared/credentialCrypto.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/v1/credential-vault/","functions/api/platform/v1/_shared/collaborationStorage.js","functions/api/platform/v1/_shared/dataStandardsStorage.js","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/","functions/api/platform/v1/ai/","docs/platform/apis/data-services-sales-v1.md","migrations/0001_production_data_access.sql","migrations/0002_business_data_apps.sql","migrations/0002_collaboration_execution.sql","migrations/0002_hr_management_core.sql","migrations/0003_product_catalog.sql","migrations/0003_platform_credentials.sql","migrations/0003_data_center_credentials.sql","migrations/0003_company_ai_assistant.sql","migrations/0004_data_standards.sql","migrations/0004_company_ai_skills.sql","migrations/0005_user_insights.sql","migrations/0005_goods_flow_core.sql","migrations/0006_shared_state_revision.sql","migrations/0006_product_catalog_components.sql"],"relations":[{"platformId":"cloudflare-pages","type":"bound-to","description":"D1 通过 Pages Functions 的环境绑定提供服务。"},{"platformId":"dingtalk","type":"stores-data-for","description":"保存钉钉会话、组织和用户令牌相关数据。"},{"platformId":"kuaimai","type":"stores-data-for","description":"保存快麦同步后的销售聚合与共享商品目录。"}]},{"id":"aliyun","name":"阿里云","status":"integrating","summary":"用于相邻服务、存储或基础设施能力，当前仍需逐项确认账号、资源和生产边界。","capabilities":["云资源","对象存储","OpenAPI","基础设施"],"businessQuestions":["阿里云资源属于哪个账号","服务部署在哪里","OpenAPI 权限如何申请","资源与 Cloudflare 的边界"],"keywords":["阿里云","Aliyun","Alibaba Cloud","OSS","OpenAPI","云服务器","开放平台"],"codePaths":["docs/platform/integrations.md","docs/decisions/**"],"envVars":[],"domains":["aliyun.com","aliyuncs.com","help.aliyun.com"],"apiRoutes":[],"publicDocs":[{"label":"阿里云帮助中心","url":"https://help.aliyun.com/"},{"label":"阿里云 OpenAPI","url":"https://help.aliyun.com/zh/openapi/api-overview/"}],"evidence":["docs/platform/integrations.md"],"relations":[{"platformId":"cloudflare-pages","type":"deployment-boundary","description":"新增云资源前需明确它与现有 Pages 生产环境的职责边界。"}]},{"id":"erp-file-import","name":"ERP / 文件导入","status":"integrating","summary":"承接销售明细、ERP 商品档案、库存单位编码、组合关系、库存快照和月度盘点文件；快麦原始文件在公司 Mac 哈希归档，线上只接收脱敏最小索引和共享业务投影，作为 API 同步的校准、补齐和兼容通道。","capabilities":["快麦官方文件历史补数","快麦每日网页导出","本地原始归档","销售明细导入","商品档案导入","库存单位编码","组合关系补齐","ERP 库存快照导入","月度盘点导入","GB18030 CSV","字段映射","内容哈希幂等","固定范围采集令牌","导入异常审计","整月重导","数据校准"],"businessQuestions":["Excel 或 CSV 导入失败","库存单位编码或供应商字段缺失","内部唯一码被误判","组合比例不一致","库存或盘点字段口径不一致","历史数据补录","API 与文件结果不同"],"keywords":["ERP","Excel","文件导入","销售明细","数据校准"],"codePaths":["src/features/settings/SalesDataSettings.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/supply-chain/InventoryWorkspace.jsx","src/domain/kuaimaiErpCollection.js","src/domain/webCollection.js","src/domain/salesData.js","src/domain/productCatalog.js","src/domain/productCatalogGraph.js","src/domain/xlsxLite.js","src/domain/supplyChain.js","src/state/salesStore.js","functions/api/sales.js","functions/api/platform/v1/erp-collection/**","functions/api/platform/v1/web-collection/**","functions/api/platform/v1/product-catalog/import.js","functions/api/platform/v1/goods-flow/imports.js","chrome-extension/company-data-collector/**","scripts/kuaimai-erp-collector/**","scripts/web-data-collector/**",".agents/skills/kuaimai-erp-data-collection/**","migrations/0006_product_catalog_components.sql","migrations/0007_kuaimai_erp_collection.sql","migrations/0009_web_collection.sql","docs/features/kuaimai-erp-history/**","docs/features/company-web-data-collector/**"],"envVars":[],"domains":[],"apiRoutes":["/api/sales","/api/platform/v1/erp-collection/ingest","/api/platform/v1/erp-collection/archives","/api/platform/v1/erp-collection/runners","/api/platform/v1/web-collection/jobs","/api/platform/v1/web-collection/runners","/api/platform/v1/product-catalog/import","/api/platform/v1/goods-flow/imports"],"publicDocs":[],"evidence":["src/features/settings/SalesDataSettings.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/supply-chain/InventoryWorkspace.jsx","src/domain/kuaimaiErpCollection.js","src/domain/salesData.js","src/domain/productCatalog.js","src/domain/productCatalogGraph.js","src/domain/xlsxLite.js","src/domain/supplyChain.js","functions/api/platform/v1/erp-collection/ingest.js","scripts/kuaimai-erp-collector/core.mjs",".agents/skills/kuaimai-erp-data-collection/SKILL.md","docs/platform/apis/erp-collection-v1.md","docs/features/kuaimai-erp-history/prd.md","migrations/0006_product_catalog_components.sql","migrations/0007_kuaimai_erp_collection.sql"],"relations":[{"platformId":"kuaimai","type":"primary-history-channel-for","description":"官方导出文件承接快麦开放平台无法完整覆盖的历史数据。"},{"platformId":"cloudflare-d1","type":"stores-imports","description":"导入归档清单、批次、最小索引、异常、聚合销售结果和标准化商品目录通过内部 API 写入 D1；完整原文件不进入 D1。"}]},{"id":"taobao-open-platform","name":"淘宝开放平台","status":"planned","summary":"计划评估淘宝商品、订单或店铺数据能力，尚未接入。","capabilities":["商品数据","订单数据","店铺数据"],"businessQuestions":["淘宝数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],"keywords":["淘宝","天猫","Taobao","TOP","开放平台","店铺"],"codePaths":[],"envVars":[],"domains":["open.taobao.com"],"apiRoutes":[],"publicDocs":[{"label":"淘宝开放平台","url":"https://open.taobao.com/"}],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认订单口径是否已经由快麦覆盖。"}]},{"id":"pinduoduo-open-platform","name":"拼多多开放平台","status":"planned","summary":"计划评估拼多多商品、订单或店铺数据能力，尚未接入。","capabilities":["商品数据","订单数据","店铺数据"],"businessQuestions":["拼多多数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],"keywords":["拼多多","Pinduoduo","PDD","开放平台","店铺"],"codePaths":[],"envVars":[],"domains":["open.pinduoduo.com"],"apiRoutes":[],"publicDocs":[{"label":"拼多多开放平台","url":"https://open.pinduoduo.com/"}],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认订单口径是否已经由快麦覆盖。"}]},{"id":"xiaohongshu-open-platform","name":"小红书开放平台","status":"planned","summary":"计划评估小红书内容、电商或分享能力，尚未接入。","capabilities":["内容分享","电商数据","应用授权"],"businessQuestions":["能否发布或同步内容","电商数据权限","商家自研应用如何授权"],"keywords":["小红书","Xiaohongshu","RED","种草","开放平台","内容"],"codePaths":[],"envVars":[],"domains":["xiaohongshu.com","xiaohongshu.apifox.cn"],"apiRoutes":[],"publicDocs":[{"label":"小红书开放平台应用开发","url":"https://xiaohongshu.apifox.cn/doc-2810909"},{"label":"小红书分享开放平台","url":"https://agora.xiaohongshu.com/"}],"evidence":[],"relations":[{"platformId":"oceanengine-qianchuan","type":"content-to-advertising","description":"内容与投放协同时需区分自然内容平台和付费投放平台的数据口径。"}]},{"id":"ugreen-nas","name":"绿联 NAS / UGOS Pro","status":"planned","summary":"计划通过公司 Mac 的 SMB/WebDAV 挂载和只读索引器关联品牌内容素材；官方未提供 MCP Server，MCP 仅作为可选文件搜索入口。","capabilities":["SMB 文件访问","WebDAV 文件访问","Docker 应用","NAS 用户认证","素材目录索引"],"businessQuestions":["品牌素材目录如何只读索引","NAS 离线和文件移动如何恢复","AI 文件搜索是否需要可选 MCP"],"keywords":["绿联 NAS","UGREEN NAS","UGOS Pro","NAS","SMB","WebDAV","素材目录","文件索引"],"codePaths":[],"envVars":[],"domains":["developer.ugnas.com","ugnas.com"],"apiRoutes":[],"publicDocs":[{"label":"绿联云开发者平台","url":"https://developer.ugnas.com/"},{"label":"UGOS Pro Docker 应用开发","url":"https://developer.ugnas.com/en/doc/backend/quick-start/develop-docker-app.html"},{"label":"绿联 NAS WebDAV 指南","url":"https://ai.ugreen.com/blogs/how-to/access-ugreen-nas-files-via-webdav"}],"evidence":[],"relations":[{"platformId":"oceanengine-qianchuan","type":"asset-to-performance","description":"NAS 内容资产通过内容主键和素材 ID 与投放表现关联，不能直接以文件名猜测归因。"}]},{"id":"oceanengine-qianchuan","name":"巨量引擎 / 巨量千川","status":"planned","summary":"计划评估广告计划、素材和投放报表能力，尚未接入。","capabilities":["广告计划","素材管理","投放报表","商品库"],"businessQuestions":["千川投放数据能否自动同步","素材表现如何归因","账户权限如何申请"],"keywords":["巨量引擎","巨量千川","千川","Ocean Engine","广告投放","素材","开放平台"],"codePaths":[],"envVars":[],"domains":["open.oceanengine.com","qianchuan.jinritemai.com"],"apiRoutes":[],"publicDocs":[{"label":"巨量引擎商业开放平台","url":"https://open.oceanengine.com/labels"}],"evidence":[],"relations":[{"platformId":"xiaohongshu-open-platform","type":"cross-channel-content","description":"跨渠道素材分析需要区分平台内容与投放数据口径。"}]},{"id":"browser-market-collector","name":"浏览器市场采集器","status":"connected","summary":"公司 Mac 通过 Chrome 调试协议只读采集已登记、已确认的平台市场类目页面，并写入用户洞察标准事实。","capabilities":["工作日采集","已登记页面白名单","用户市场","商品市场","视频市场","直播市场","页面结构版本","登录失效停止","幂等批次"],"businessQuestions":["平台市场数据没有更新","页面要求重新登录","页面字段发生变化","类目尚未确认","采集器未连接","周末为什么未自动采集"],"keywords":["用户洞察","浏览器采集","市场","类目","竞品","Chrome","CDP"],"codePaths":["scripts/user-insights-collector/**","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/**","src/domain/userInsights.js","src/state/userInsightsApi.js","src/state/UserInsightsProvider.jsx","src/features/data-center/UserInsightsWorkspace.jsx","src/features/data-center/user-insights.css","docs/features/user-insights/**","docs/platform/apis/user-insights-v1.md","docs/platform/browser-market-collection.md","migrations/0005_user_insights.sql"],"envVars":[],"domains":[],"apiRoutes":["/api/platform/v1/user-insights","/api/platform/v1/user-insights/collector","/api/platform/v1/user-insights/ingest"],"publicDocs":[],"evidence":["scripts/user-insights-collector/","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/","src/domain/userInsights.js","src/state/userInsightsApi.js","src/state/UserInsightsProvider.jsx","src/features/data-center/UserInsightsWorkspace.jsx","docs/features/user-insights/","migrations/0005_user_insights.sql"],"relations":[{"platformId":"cloudflare-pages","type":"writes-through","description":"采集器只能通过受限 Pages Functions ingest 契约写入，不能直连 D1。"},{"platformId":"cloudflare-d1","type":"stores-standard-facts","description":"D1 只保存标准事实、规则、质量和审计，不保存完整页面、Cookie 或凭证。"}]},{"id":"lingsuan-ai-gateway","name":"灵算 AI 网关","status":"connected","summary":"为公司统一 AI 提供服务端 Responses 兼容调用；凭据优先来自平台连接保险箱，业务 App 不直连 Provider。","capabilities":["Responses 流式生成","非流式业务调用","固定模型配置","原生 Function Calling 能力探测","服务端受控 Skill 路由","公司只读 Skills","App 与功能归属审计","Token 与 Skill 聚合","规则降级","合成连接测试","保险箱凭据管理","最高权限受控查看","无留存请求参数","安全错误映射"],"businessQuestions":["AI 大模型不可用","模型服务连接失败","哪些 App 和功能使用 AI","Token 消耗多少","Skill 调用失败","响应超时或限流","公司数据能否外发","密钥是否安全"],"keywords":["灵算","LingSuan","AI 大模型","AI 总助","AI 点评","Token","Responses API","Function Calling","Skills","LINGSUAN_API_KEY"],"codePaths":["functions/api/platform/v1/ai/**","functions/api/ecommerce-operations/ai-review.js","functions/api/platform/_shared/platformConnectionTesters.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/platform-connections/[platformId]/reveal.js","src/domain/aiAssistant.js","src/domain/aiModelGovernance.js","src/domain/platformConnections.js","src/state/aiAssistant*.js","src/state/aiModelGovernanceApi.js","src/state/platformConnectionsApi.js","src/state/usePlatformConnections.js","src/features/ai-assistant/**","src/features/data-center/AiModelWorkspace.jsx","src/features/data-center/AiProviderSettings.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","migrations/0003_company_ai_assistant.sql","migrations/0004_company_ai_skills.sql","migrations/0009_ai_model_governance.sql","migrations/0010_platform_credential_reveal.sql"],"envVars":["AI_ASSISTANT_ENABLED","LINGSUAN_API_KEY","LINGSUAN_ACTOR_AUTHORIZATION"],"domains":["lingsuan.top"],"apiRoutes":["/api/platform/v1/ai/status","/api/platform/v1/ai/provider","/api/platform/v1/ai/provider/test","/api/platform/v1/ai/chat","/api/platform/v1/ai/usage","/api/platform/v1/platform-connections/:platformId/reveal","/api/ecommerce-operations/ai-review"],"publicDocs":[{"label":"灵算 AI API Gateway","url":"https://lingsuan.top/"}],"evidence":["src/domain/aiAssistant.js","src/domain/aiModelGovernance.js","src/features/data-center/AiModelWorkspace.jsx","src/features/data-center/AiProviderSettings.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","functions/api/platform/v1/ai/_shared/invoke-feature.js","functions/api/platform/v1/ai/_shared/routed-skill-fallback.js","functions/api/platform/v1/ai/usage.js","functions/api/platform/v1/platform-connections/[platformId]/reveal.js","functions/api/ecommerce-operations/ai-review.js","react-tests/ai-model-governance.test.mjs","react-tests/platform-connections.test.mjs","tests/ai-feature-invocation.test.mjs","tests/ai-usage-api.test.mjs","tests/ai-skill-loop.test.mjs","tests/platform-connections-reveal-api.test.mjs","migrations/0003_company_ai_assistant.sql","migrations/0004_company_ai_skills.sql","migrations/0009_ai_model_governance.sql","migrations/0010_platform_credential_reveal.sql"],"relations":[{"platformId":"cloudflare-pages","type":"called-by","description":"Pages Functions 在服务端调用 Provider，浏览器不接触密钥或公司上下文。"},{"platformId":"cloudflare-d1","type":"governed-by","description":"D1 保存 Provider 安全元数据、外发策略、并发租约和无内容审计。"}]},{"id":"kuaishou-ecosystem","name":"快手生态","status":"planned","summary":"计划接入快手小店和广告账户的经营与投放数据，尚未接入。","capabilities":["店铺订单","商品数据","经营报表","广告数据","网页导出"],"businessQuestions":["快手小店与广告账户如何区分","登录验证如何处理","经营和投放口径如何关联"],"keywords":["快手","快手小店","磁力引擎","Kuaishou","店铺后台"],"codePaths":[],"envVars":[],"domains":[],"apiRoutes":[],"publicDocs":[],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认快手订单是否已由快麦覆盖。"}]},{"id":"jd-jingmai","name":"京东 / 京麦","status":"planned","summary":"计划接入京东店铺和京麦后台的订单、商品与经营数据，尚未接入。","capabilities":["店铺订单","商品数据","经营报表","网页导出"],"businessQuestions":["京麦账号如何授权","扫码或设备验证如何处理","与快麦订单是否重复"],"keywords":["京东","京麦","JD","Jingmai","店铺后台"],"codePaths":[],"envVars":[],"domains":[],"apiRoutes":[],"publicDocs":[],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认京东订单是否已由快麦覆盖。"}]}]'),Oe={platforms:Ce},je=["connected","integrating","planned","retired"],be=a=>String(a??"").replace(/\s+/g," ").trim().toLocaleLowerCase("zh-CN");function Le(a,e=[]){const s=new Map((Array.isArray(e)?e:[]).filter(t=>t?.platformId).map(t=>[t.platformId,t]));return(a?.platforms||[]).map(t=>({...t,internal:s.get(t.id)||null}))}function ke(a,{query:e="",status:s="all"}={}){const t=be(e);return(a||[]).filter(l=>s!=="all"&&l.status!==s?!1:t?[l.id,l.name,l.summary,...l.capabilities||[],...l.businessQuestions||[],...l.keywords||[]].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function ye(a){const e=Object.fromEntries(["all",...je].map(s=>[s,0]));for(const s of a||[])e.all+=1,Object.hasOwn(e,s.status)&&(e[s.status]+=1);return e}function xe(a,e){const s=new Map((a||[]).map(t=>[t.id,t]));return(e?.relations||[]).flatMap(t=>{const l=s.get(t.platformId);return l?[{...t,platform:l}]:[]})}function we(a,{now:e=new Date,staleDays:s=180}={}){const t=Date.parse(`${a?.verifiedAt||""}T00:00:00Z`);return Number.isNaN(t)?!0:(e.getTime()-t)/864e5>s}function nn(){return"/api/platform/v1/integrations"}async function en(a){const e=await a.json().catch(()=>({}));if(!a.ok)throw new Error(e.message||`内部平台资料请求失败（HTTP ${a.status}）。`);return e}async function Me({hostname:a="",fetchImpl:e=fetch}={}){try{const s=await e(nn(a),{credentials:"include"}),t=await en(s);return Array.isArray(t.profiles)?t.profiles:[]}catch(s){throw s?.message&&!/failed to fetch|networkerror/i.test(s.message)?s:new Error("无法连接内部平台资料服务。")}}async function Ue(a,{hostname:e="",fetchImpl:s=fetch}={}){try{const t=await s(nn(e),{method:"PUT",credentials:"include",headers:{"content-type":"application/json"},body:JSON.stringify(a)});return(await en(t)).profile}catch(t){throw t?.message&&!/failed to fetch|networkerror/i.test(t.message)?t:new Error("无法连接内部平台资料服务。")}}const j=[{id:"all",label:"全部"},{id:"connected",label:"已连接"},{id:"integrating",label:"集成中"},{id:"planned",label:"计划中"},{id:"retired",label:"已停用"}],Ve={consoleUrl:"",accountSubject:"",resourceNamesText:"",environmentsText:"",owner:"",permissionGuide:"",runbook:"",verifiedAt:""};function Ge(a){return a?{consoleUrl:a.consoleUrl||"",accountSubject:a.accountSubject||"",resourceNamesText:(a.resourceNames||[]).join(`
`),environmentsText:(a.environments||[]).map(e=>[e.name,e.url,e.notes].join(" | ")).join(`
`),owner:a.owner||"",permissionGuide:a.permissionGuide||"",runbook:a.runbook||"",verifiedAt:a.verifiedAt||""}:Ve}function Fe(a,e){return{platformId:a,consoleUrl:e.consoleUrl,accountSubject:e.accountSubject,resourceNames:e.resourceNamesText.split(/\r?\n/).map(s=>s.trim()).filter(Boolean),environments:e.environmentsText.split(/\r?\n/).flatMap(s=>{const[t="",l="",...o]=s.split("|").map(u=>u.trim());return t?[{name:t,url:l,notes:o.join(" | ")}]:[]}),owner:e.owner,permissionGuide:e.permissionGuide,runbook:e.runbook,verifiedAt:e.verifiedAt}}function Be({platform:a,saving:e,error:s,onCancel:t,onSave:l}){const[o,u]=p.useState(()=>Ge(a.internal)),d=(r,A)=>u(I=>({...I,[r]:A}));return n.jsxs("form",{className:"integration-profile-editor",onSubmit:r=>{r.preventDefault(),l(Fe(a.id,o))},children:[n.jsxs("div",{className:"integration-editor-heading",children:[n.jsxs("div",{children:[n.jsx("strong",{children:"维护内部资料"}),n.jsx("p",{children:"只填写入口、主体、资源和责任信息；凭据必须保存在密钥管理系统。"})]}),n.jsx("button",{className:"icon-action",type:"button","aria-label":"关闭编辑",onClick:t,disabled:e,children:n.jsx(V,{size:16,"aria-hidden":"true"})})]}),n.jsxs("div",{className:"integration-form-grid",children:[n.jsxs("label",{children:[n.jsx("span",{children:"内部控制台 URL"}),n.jsx("input",{type:"url",value:o.consoleUrl,onChange:r=>d("consoleUrl",r.target.value),placeholder:"https://"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"账号主体"}),n.jsx("input",{value:o.accountSubject,onChange:r=>d("accountSubject",r.target.value),placeholder:"公司或业务主体"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"负责人"}),n.jsx("input",{value:o.owner,onChange:r=>d("owner",r.target.value),placeholder:"姓名或岗位"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"最近验证日期"}),n.jsx("input",{type:"date",value:o.verifiedAt,onChange:r=>d("verifiedAt",r.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"应用 / 实例 / 店铺名称"}),n.jsx("textarea",{rows:"3",value:o.resourceNamesText,onChange:r=>d("resourceNamesText",r.target.value),placeholder:"每行一个名称"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"环境"}),n.jsx("textarea",{rows:"3",value:o.environmentsText,onChange:r=>d("environmentsText",r.target.value),placeholder:"生产 | https://example.com/ | 钉钉工作台"}),n.jsx("small",{children:"每行格式：环境名 | HTTPS URL | 说明"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"权限申请路径"}),n.jsx("textarea",{rows:"2",value:o.permissionGuide,onChange:r=>d("permissionGuide",r.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"内部运行手册"}),n.jsx("textarea",{rows:"2",value:o.runbook,onChange:r=>d("runbook",r.target.value),placeholder:"知识库位置或简短操作说明"})]})]}),s?n.jsx("p",{className:"integration-form-error",role:"alert",children:s}):null,n.jsxs("div",{className:"integration-editor-actions",children:[n.jsx("button",{className:"btn",type:"button",onClick:t,disabled:e,children:"取消"}),n.jsx("button",{className:"btn primary",type:"submit",disabled:e,children:e?"正在保存…":"保存内部资料"})]})]})}function Ke({platform:a,loading:e}){if(e)return n.jsxs("div",{className:"integration-profile-loading","aria-busy":"true",children:[n.jsx("span",{}),n.jsx("span",{}),n.jsx("span",{}),n.jsx("small",{children:"正在读取内部资料…"})]});const s=a.internal;return s?n.jsxs("div",{className:"integration-profile-content",children:[we(s)?n.jsxs("p",{className:"integration-stale",children:[n.jsx(O,{size:15,"aria-hidden":"true"}),"资料超过 180 天未验证，请联系负责人复核。"]}):null,n.jsxs("dl",{children:[n.jsxs("div",{children:[n.jsx("dt",{children:"账号主体"}),n.jsx("dd",{children:s.accountSubject||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"负责人"}),n.jsx("dd",{children:s.owner||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"最近验证"}),n.jsx("dd",{children:s.verifiedAt||"未验证"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"维护人"}),n.jsx("dd",{children:s.updatedBy||"未知"})]})]}),s.consoleUrl?n.jsxs("a",{className:"integration-console-link",href:s.consoleUrl,target:"_blank",rel:"noreferrer",children:["打开内部控制台 ",n.jsx(Q,{size:14,"aria-hidden":"true"})]}):null,s.resourceNames?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"应用 / 实例 / 店铺"}),n.jsx("ul",{children:s.resourceNames.map(t=>n.jsx("li",{children:t},t))})]}):null,s.environments?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"环境"}),n.jsx("ul",{children:s.environments.map(t=>n.jsxs("li",{children:[n.jsx("b",{children:t.name}),t.url?n.jsx("a",{href:t.url,target:"_blank",rel:"noreferrer",children:t.url}):null,t.notes?n.jsx("span",{children:t.notes}):null]},`${t.name}-${t.url}`))})]}):null,s.permissionGuide?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"权限申请路径"}),n.jsx("p",{children:s.permissionGuide})]}):null,s.runbook?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"内部运行手册"}),n.jsx("p",{children:s.runbook})]}):null]}):n.jsxs("div",{className:"integration-profile-empty",children:[n.jsx(z,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料尚未维护"}),n.jsx("p",{children:"平台管理员可补充控制台、账号主体、负责人和运行手册。"})]})]})}function He({sessionUser:a}){const[e,s]=p.useState([]),[t,l]=p.useState("loading"),[o,u]=p.useState(""),[d,r]=p.useState(""),[A,I]=p.useState("all"),[g,R]=p.useState("dingtalk"),[D,T]=p.useState(!1),[N,c]=p.useState(!1),[m,v]=p.useState(""),[S,C]=p.useState("");p.useEffect(()=>{let i=!0;return Me({hostname:window.location.hostname}).then(E=>{i&&(s(E),l("ready"))}).catch(E=>{i&&(u(E?.message||"内部资料暂不可用。"),l("error"))}),()=>{i=!1}},[]);const h=p.useMemo(()=>Le(Oe,e),[e]),f=p.useMemo(()=>ye(h),[h]),P=p.useMemo(()=>ke(h,{query:d,status:A}),[h,d,A]),_=P.find(i=>i.id===g)||P[0]||null,F=p.useMemo(()=>xe(h,_),[h,_]),an=q(a)&&a?.role!=="readonly",sn=i=>{R(i),T(!1),v(""),C("")},tn=async i=>{c(!0),v(""),C("");try{const E=await Ue(i,{hostname:window.location.hostname});s(on=>[...on.filter(rn=>rn.platformId!==E.platformId),E]),T(!1),C("内部资料已保存。公开注册表未被修改。")}catch(E){v(E?.message||"内部平台资料保存失败。")}finally{c(!1)}};return n.jsxs("section",{className:"integration-map","aria-label":"外部平台地图",children:[t==="error"?n.jsxs("div",{className:"integration-degraded",role:"status",children:[n.jsx(O,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料暂不可用"}),n.jsxs("p",{children:[o," 公开平台资料仍可正常查看。"]})]})]}):null,n.jsxs("div",{className:"integration-map-toolbar",children:[n.jsxs("label",{className:"integration-map-search",children:[n.jsx(y,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索平台、能力或问题"}),n.jsx("input",{type:"search",value:d,onChange:i=>r(i.target.value),placeholder:"搜索平台、能力或问题"}),d?n.jsx("button",{type:"button","aria-label":"清除平台搜索",onClick:()=>r(""),children:n.jsx(V,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"integration-status-filters","aria-label":"平台状态筛选",children:j.map(i=>n.jsxs("button",{type:"button","aria-pressed":A===i.id,className:A===i.id?"active":"",onClick:()=>I(i.id),children:[i.label,n.jsx("span",{children:f[i.id]})]},i.id))})]}),P.length?n.jsxs("div",{className:"integration-map-workspace",children:[n.jsx("nav",{className:"integration-platform-list","aria-label":"外部平台",children:P.map(i=>n.jsxs("button",{type:"button",className:_?.id===i.id?"active":"","aria-current":_?.id===i.id?"true":void 0,onClick:()=>sn(i.id),children:[n.jsx("span",{className:`integration-status-dot ${i.status}`,"aria-hidden":"true"}),n.jsxs("span",{children:[n.jsx("strong",{children:i.name}),n.jsx("small",{children:i.capabilities.slice(0,2).join(" · ")})]}),n.jsx("em",{className:`integration-status-label ${i.status}`,children:j.find(E=>E.id===i.status)?.label})]},i.id))}),n.jsxs("div",{className:"integration-platform-detail",children:[n.jsxs("header",{className:"integration-detail-header",children:[n.jsxs("div",{children:[n.jsxs("div",{className:"integration-detail-title",children:[n.jsx("h2",{children:_.name}),n.jsx("span",{className:`integration-status-label ${_.status}`,children:j.find(i=>i.id===_.status)?.label})]}),n.jsx("p",{children:_.summary})]}),an&&!D?n.jsxs("button",{className:"btn compact",type:"button",onClick:()=>{T(!0),v("")},children:[n.jsx(mn,{size:14,"aria-hidden":"true"}),"维护内部资料"]}):null]}),S?n.jsxs("p",{className:"integration-save-success",role:"status",children:[n.jsx(_n,{size:15,"aria-hidden":"true"}),S]}):null,n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"能力与常见问题"}),n.jsx("div",{className:"integration-capabilities",children:_.capabilities.map(i=>n.jsx("span",{children:i},i))}),n.jsx("ul",{className:"integration-question-list",children:_.businessQuestions.map(i=>n.jsx("li",{children:i},i))})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"关联关系"}),F.length?n.jsx("ul",{className:"integration-relation-list",children:F.map(i=>n.jsxs("li",{children:[n.jsx(An,{size:15,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:i.platform.name}),n.jsx("p",{children:i.description})]}),n.jsx("span",{children:j.find(E=>E.id===i.platform.status)?.label})]},`${i.platform.id}-${i.type}`))}):n.jsx("p",{children:"当前没有登记的一层关联平台。"})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"官方公开文档"}),_.publicDocs.length?n.jsx("div",{className:"integration-public-links",children:_.publicDocs.map(i=>n.jsxs("a",{href:i.url,target:"_blank",rel:"noreferrer",children:[i.label,n.jsx(Q,{size:14,"aria-hidden":"true"})]},i.url))}):n.jsx("p",{children:"该能力是内部文件导入边界，没有独立的外部官方文档。"})]}),n.jsxs("section",{className:"integration-detail-section integration-private-section",children:[n.jsxs("div",{className:"integration-section-heading",children:[n.jsx("h3",{children:"公司内部资料"}),n.jsx("span",{children:"登录后可见"})]}),D?n.jsx(Be,{platform:_,saving:N,error:m,onCancel:()=>{T(!1),v("")},onSave:tn},_.id):n.jsx(Ke,{platform:_,loading:t==="loading"})]})]})]}):n.jsxs("div",{className:"integration-map-empty",children:[n.jsx(y,{size:22,"aria-hidden":"true"}),n.jsx("strong",{children:"没有匹配的平台"}),n.jsx("p",{children:"换一个关键词，或清除状态筛选查看全部平台。"}),n.jsx("button",{className:"btn",type:"button",onClick:()=>{r(""),I("all")},children:"查看全部平台"})]})]})}async function L(a,e){const s=await fetch(a,e),t=await s.json().catch(()=>({}));if(!s.ok){const l=new Error(t.message||`环境状态请求失败（HTTP ${s.status}）。`);throw l.code=t.error?.code||"ENVIRONMENT_REQUEST_FAILED",l}return t}function We(){return L("/api/platform/v1/environment-readiness")}function Ye({reason:a,confirmation:e}){return L("/api/platform/v1/production-write-session",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({reason:a,confirmation:e})})}function qe(){return L("/api/platform/v1/production-write-session",{method:"DELETE"})}function Qe({auditId:a,confirmation:e}){return L("/api/platform/v1/production-data/rollback",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({auditId:a,confirmation:e})})}const ze={development:"本地测试",preview:"预览环境",production:"生产环境"},$e={ready:"已就绪",warning:"有警告",blocked:"阻断"},Je={PRODUCT_FLOW_DB:"公司数据库连接",PLATFORM_CREDENTIAL_MASTER_KEY:"平台连接安全保护",DINGTALK_APP_KEY:"钉钉应用凭证",DINGTALK_APP_SECRET:"钉钉应用密钥",KUAIMAI_APP_KEY:"快麦应用凭证",KUAIMAI_APP_SECRET:"快麦应用密钥",KUAIMAI_ACCESS_TOKEN:"快麦访问授权"};function Xe(a){return Je[a]||(String(a).includes("_")?"系统运行配置":a)}function Ze(a=[]){const e=[...new Set(a.filter(s=>["dingtalk","kuaimai"].includes(s)))];return e.length===1&&e[0]==="dingtalk"?"#/data-sources/company":e.length===1&&e[0]==="kuaimai"?"#/data-sources/erp":"#/data-sources"}function na({status:a}){return a==="ready"?n.jsx(J,{size:17,"aria-hidden":"true"}):a==="warning"?n.jsx(O,{size:17,"aria-hidden":"true"}):n.jsx($,{size:17,"aria-hidden":"true"})}function ea(){return n.jsxs("div",{className:"environment-loading","aria-busy":"true","aria-label":"正在检查环境状态",children:[n.jsx("span",{}),n.jsx("span",{}),n.jsx("span",{}),n.jsx("p",{children:"正在核对环境变量、数据库绑定和平台能力…"})]})}function aa({capabilities:a=[]}){return n.jsxs("section",{className:"environment-section","aria-labelledby":"environment-capability-title",children:[n.jsx("div",{className:"environment-section-heading",children:n.jsxs("div",{children:[n.jsx("h2",{id:"environment-capability-title",children:"能力检查"}),n.jsx("p",{children:"只展示配置是否存在，不读取或显示密钥内容。"})]})}),n.jsx("div",{className:"environment-capability-grid",children:a.map(e=>n.jsxs("article",{className:`environment-capability ${e.status}`,children:[n.jsxs("div",{className:"environment-capability-heading",children:[n.jsx("span",{className:"environment-status-icon",children:n.jsx(na,{status:e.status})}),n.jsxs("div",{children:[n.jsx("h3",{children:e.name}),n.jsx("p",{children:e.description})]}),n.jsx("strong",{children:$e[e.status]||e.status})]}),e.missing?.length?n.jsxs("div",{className:"environment-missing",children:[n.jsx("span",{children:"需要处理"}),n.jsx("ul",{children:e.missing.map(s=>n.jsx("li",{title:s,children:Xe(s)},s))}),e.platforms?.some(s=>["dingtalk","kuaimai"].includes(s))?n.jsx("a",{className:"btn compact",href:Ze(e.platforms),children:"前往数据接入"}):null]}):n.jsxs("p",{className:"environment-complete",children:[n.jsx(gn,{size:15,"aria-hidden":"true"}),"必要配置与表结构完整"]})]},e.id))})]})}function sa({audits:a=[],canRollback:e,busy:s,onRollback:t}){const[l,o]=p.useState(""),[u,d]=p.useState("");return a.length?n.jsx("div",{className:"environment-audit-list",children:a.map(r=>{const A=l===r.id,I=e&&r.status==="succeeded"&&r.snapshot_id;return n.jsxs("article",{className:"environment-audit-row",children:[n.jsxs("div",{children:[n.jsx("strong",{children:r.action==="rollback"?"回滚生产数据":"修改生产数据"}),n.jsx("p",{children:r.reason||"未记录原因"}),n.jsxs("small",{children:[r.name||"未知账号"," · ",new Date(r.created_at).toLocaleString("zh-CN")]})]}),n.jsx("span",{className:`environment-audit-status ${r.status}`,children:r.status==="succeeded"?"成功":r.status}),I?n.jsxs("button",{type:"button",className:"btn compact",onClick:()=>{o(A?"":r.id),d("")},disabled:s,children:[n.jsx(En,{size:14}),"回滚"]}):null,A?n.jsxs("div",{className:"environment-rollback-confirm",children:[n.jsxs("label",{children:[n.jsx("span",{children:"输入“修改线上真实数据”确认回滚"}),n.jsx("input",{value:u,onChange:g=>d(g.target.value)})]}),n.jsx("button",{type:"button",className:"btn danger compact",disabled:s||u!=="修改线上真实数据",onClick:()=>t(r.id,u),children:"确认回滚"})]}):null]},r.id)})}):n.jsx("p",{className:"environment-audit-empty",children:"还没有跨环境生产写入记录。"})}function ta({sessionUser:a}){const[e,s]=p.useState(null),[t,l]=p.useState("loading"),[o,u]=p.useState(""),[d,r]=p.useState(!1),[A,I]=p.useState(""),[g,R]=p.useState(""),[D,T]=p.useState(""),N=p.useCallback(async()=>{l("loading"),u("");try{s(await We()),l("ready")}catch(f){u(f?.message||"环境状态暂时无法读取。"),l("error")}},[]);p.useEffect(()=>{N()},[N]);const c=e?.dataAccess||{},m=e?.environment==="development",v=q(a)&&a?.role!=="readonly",S=m&&v&&c.configured,C=p.useMemo(()=>c.expiresAt?Math.max(0,Math.ceil((Date.parse(c.expiresAt)-Date.now())/6e4)):0,[c.expiresAt]),h=async(f,P)=>{r(!0),u(""),I("");try{await f(),I(P),await N()}catch(_){u(_?.message||"操作失败，请重试。")}finally{r(!1)}};return t==="loading"&&!e?n.jsx(ea,{}):t==="error"&&!e?n.jsxs("div",{className:"environment-load-error",role:"alert",children:[n.jsx($,{size:20}),n.jsxs("div",{children:[n.jsx("strong",{children:"环境状态暂不可用"}),n.jsx("p",{children:o}),n.jsx("button",{type:"button",className:"btn",onClick:N,children:"重新检查"})]})]}):n.jsxs("section",{className:"environment-readiness","aria-label":"环境与生产数据",children:[n.jsxs("header",{className:`environment-overview ${e.ready?"ready":"blocked"}`,children:[n.jsx("div",{className:"environment-overview-icon",children:e.ready?n.jsx(J,{size:22}):n.jsx(O,{size:22})}),n.jsxs("div",{children:[n.jsx("span",{children:ze[e.environment]||e.environment}),n.jsx("h2",{children:e.ready?"生产环境配置完整":"生产环境缺少必要配置"}),n.jsx("p",{children:e.ready?"数据库、钉钉和生产数据控制能力已通过必要检查。":"存在阻断项，不能完成发布验收；请按下方缺少项补齐。"})]}),n.jsxs("button",{type:"button",className:"btn compact",onClick:N,disabled:d||t==="loading",children:[n.jsx(In,{size:14}),"重新检查"]})]}),c.unlocked?n.jsxs("div",{className:"production-write-active",role:"alert",children:[n.jsx(B,{size:19}),n.jsxs("div",{children:[n.jsx("strong",{children:"正在修改线上真实数据"}),n.jsxs("p",{children:["剩余约 ",C," 分钟 · 原因：",c.reason]})]}),n.jsx("button",{type:"button",className:"btn danger compact",disabled:d,onClick:()=>h(qe,"生产写入已锁定。"),children:"立即锁定"})]}):null,o?n.jsx("p",{className:"environment-inline-error",role:"alert",children:o}):null,A?n.jsx("p",{className:"environment-inline-success",role:"status",children:A}):null,n.jsx(aa,{capabilities:e.capabilities}),m?n.jsxs("section",{className:"environment-section production-access-section","aria-labelledby":"production-access-title",children:[n.jsxs("div",{className:"environment-section-heading",children:[n.jsxs("div",{children:[n.jsx("h2",{id:"production-access-title",children:"生产数据访问"}),n.jsx("p",{children:"本地默认实时读取生产数据，写入必须由指定最高权限账号短时解锁。"})]}),n.jsxs("span",{className:`environment-access-badge ${c.configured?"configured":"missing"}`,children:[n.jsx(z,{size:14}),c.configured?"已连接生产数据":"未配置个人令牌"]})]}),c.configured?null:n.jsxs("div",{className:"environment-access-help",children:[n.jsx(fn,{size:18}),n.jsxs("div",{children:[n.jsx("strong",{children:"当前保持本地数据模式"}),n.jsxs("p",{children:["在被忽略的 ",n.jsx("code",{children:".env"})," 中配置 ",n.jsx("code",{children:"PRODUCTION_DATA_ACCESS_TOKEN"})," 后重启本地服务。"]})]})]}),c.configured&&!v?n.jsx("p",{className:"environment-no-permission",children:"当前账号可以查看真实数据，但没有生产写入解锁权限。"}):null,S&&!c.unlocked?n.jsxs("form",{className:"production-unlock-form",onSubmit:f=>{f.preventDefault(),h(()=>Ye({reason:g,confirmation:D}),"生产写入已解锁 15 分钟。")},children:[n.jsxs("div",{className:"production-unlock-warning",children:[n.jsx(O,{size:18}),n.jsx("p",{children:"接下来的测试修改会直接写入线上数据库，并记录审计。钉钉等外部真实操作仍保持禁止。"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"修改原因"}),n.jsx("input",{value:g,onChange:f=>R(f.target.value),minLength:"4",maxLength:"200",placeholder:"例如：修正测试中发现的产品状态"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"输入“修改线上真实数据”确认"}),n.jsx("input",{value:D,onChange:f=>T(f.target.value)})]}),n.jsxs("button",{type:"submit",className:"btn danger",disabled:d||g.trim().length<4||D!=="修改线上真实数据",children:[n.jsx(B,{size:15}),"解锁 15 分钟生产写入"]})]}):null,n.jsxs("div",{className:"environment-audit-heading",children:[n.jsx("h3",{children:"最近生产数据审计"}),n.jsx("span",{children:"最多显示 30 条"})]}),n.jsx(sa,{audits:e.audit||[],canRollback:S&&c.unlocked,busy:d,onRollback:(f,P)=>h(()=>Qe({auditId:f,confirmation:P}),"生产数据已回滚，并生成新的审计记录。")})]}):null]})}const ia=Object.fromEntries(X.map(a=>[a.id,a.label])),Y={guide:"使用说明",product:"产品说明",design:"设计书",specification:"设计规格",platform:"平台能力"},oa=a=>Object.entries(ia).map(([e,s])=>({category:e,label:s,documents:a.filter(t=>t.category===e)})).filter(e=>e.documents.length);function ua({selectedSlug:a,onSelectDocument:e,sessionUser:s}){const[t,l]=p.useState(""),o=Tn(k,a,M),[u,d]=p.useState(()=>o?.category??"handbook"),r=p.useMemo(()=>Dn(k,{query:t,category:u}),[u,t]),A=p.useMemo(()=>oa(r),[r]),I=o?.slug==="platform/external-platform-map",g=o?.slug==="platform/environment-readiness",R=I||g,D=p.useMemo(()=>Nn(o?.content),[o]);p.useEffect(()=>{a&&o?.category&&d(o.category)},[o?.category,a]);const T=c=>{if(d(c),o?.category!==c){const m=k.find(v=>v.category===c);m&&e?.(m.slug)}},N=(c,m)=>{c.preventDefault(),document.getElementById(m)?.scrollIntoView({behavior:"smooth",block:"start"})};return n.jsxs("section",{className:"page handbook-page",children:[n.jsx(un,{title:"说明书",description:"公司的工作方法、产品定义、设计决策与共享平台能力，以仓库文档为准。"}),n.jsxs("div",{className:"handbook-tools",role:"search",children:[n.jsxs("label",{className:"handbook-search",children:[n.jsx(y,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索说明书"}),n.jsx("input",{type:"search",value:t,onChange:c=>l(c.target.value),placeholder:"搜索说明书"}),t?n.jsx("button",{type:"button","aria-label":"清除搜索",onClick:()=>l(""),children:n.jsx(V,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"handbook-filters","aria-label":"说明书分类",children:X.map(c=>n.jsx("button",{type:"button",className:u===c.id?"active":"","aria-pressed":u===c.id,onClick:()=>T(c.id),children:c.label},c.id))})]}),r.length&&o?n.jsxs("div",{className:`handbook-workspace${I?" platform-map-open":""}${g?" environment-readiness-open":""}`,children:[n.jsx("nav",{className:"handbook-catalog","aria-label":"说明书目录",children:A.map(c=>n.jsxs("section",{className:"handbook-catalog-group","data-category":c.category,children:[n.jsx("h2",{children:c.label}),n.jsx("div",{className:"handbook-document-list",children:c.documents.map(m=>n.jsxs("button",{type:"button",className:o.slug===m.slug?"active":"","aria-current":o.slug===m.slug?"page":void 0,onClick:()=>e?.(m.slug),children:[n.jsx("strong",{children:m.title}),n.jsx("small",{children:Y[m.kind]??m.kind})]},m.slug))})]},c.category))}),n.jsxs("article",{className:`handbook-article${I?" handbook-article-platform-map":""}${g?" handbook-article-environment-readiness":""}`,children:[n.jsxs("header",{className:"handbook-document-header",children:[n.jsxs("div",{className:"handbook-document-kind",children:[n.jsx(K,{size:15,"aria-hidden":"true"}),Y[o.kind]??o.kind]}),n.jsx("h1",{children:o.title}),n.jsx("p",{children:o.summary}),n.jsxs("time",{dateTime:o.updatedAt,children:["更新于 ",o.updatedAt]})]}),I?n.jsx(He,{sessionUser:s}):g?n.jsx(ta,{sessionUser:s}):n.jsx(Sn,{content:Pn(o.content)})]}),R?null:n.jsxs("aside",{className:"handbook-toc","aria-label":"本页目录",children:[n.jsx("strong",{children:"本页目录"}),D.length?n.jsx("ol",{children:D.map(c=>n.jsx("li",{className:`level-${c.level}`,children:n.jsx("a",{href:`#${c.id}`,onClick:m=>N(m,c.id),children:c.title})},`${c.id}-${c.level}`))}):n.jsx("small",{children:"本页没有分节标题"})]})]}):n.jsxs("div",{className:"handbook-empty",children:[n.jsx(K,{size:24,"aria-hidden":"true"}),n.jsx("strong",{children:"没有找到匹配的说明"}),n.jsx("span",{children:"换一个关键词，或返回使用手册查看现有文档。"}),n.jsx("button",{type:"button",className:"btn",onClick:()=>{l(""),T("handbook")},children:"返回使用手册"})]})]})}export{ua as default};
