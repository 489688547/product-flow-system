import{j as n,r as c}from"./react-vendor-Cdl46aim.js";import{B as en,M as sn,r as tn,a as an}from"./markdown-vendor-CTibGXZM.js";import{P as on}from"./PageHeader-DZv__LwJ.js";import{j as rn}from"./index-BEEuKcxP.js";import{t as F,Q as T,X as C,y as ln,v as dn,N as cn,E as K,a8 as un,g as L}from"./icons-vendor-mXgWO-PT.js";const z=[{id:"handbook",label:"使用手册"},{id:"product",label:"产品与设计"},{id:"platform",label:"平台能力"}],v=e=>String(e??"").replace(/\s+/g," ").trim(),N=e=>/^#{1,6}\s|^(```|~~~|>|[-*+]\s|\d+[.)]\s|\|)/.test(e),O=e=>v(e.replace(/!\[([^\]]*)\]\([^)]*\)/g,"$1").replace(/\[([^\]]+)\]\([^)]*\)/g,"$1").replace(/[`*_~]/g,"")),pn=e=>{const s=String(e??"").match(/^#\s+(.+?)\s*#*\s*$/m);return s?O(s[1]):"未命名说明"},mn=e=>{const s=String(e??"").split(/\r?\n/);for(let a=0;a<s.length;a+=1){const t=s[a].trim();if(!t||N(t))continue;const r=[t];for(;s[a+1]?.trim()&&!N(s[a+1].trim());)r.push(s[a+1].trim()),a+=1;return O(r.join(" "))}return"暂无摘要"};function E(e){const s=String(e.content??"");return{...e,content:s,title:v(e.title)||pn(s),summary:v(e.summary)||mn(s)}}function gn(e,{query:s="",category:a="all"}={}){const t=v(s).toLocaleLowerCase("zh-CN");return e.filter(r=>a&&a!=="all"&&r.category!==a?!1:t?[r.title,r.summary,r.content].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function hn(e,s,a){return e.length?e.find(t=>t.slug===s)??e.find(t=>t.slug===a)??e[0]:null}function In(e){const s=new en,a=[],t=/^(#{2,3})\s+(.+?)\s*#*\s*$/gm;let r;for(;(r=t.exec(String(e??"")))!==null;){const o=O(r[2]);a.push({level:r[1].length,title:o,id:s.slug(o)})}return a}function fn(e){const s=String(e??""),a=s.split(/\r?\n/);let t=0;for(;t<a.length&&!a[t].trim();)t+=1;if(!/^#\s+/.test(a[t]?.trim()??""))return s;for(t+=1;t<a.length&&!a[t].trim();)t+=1;if(a[t]?.trim()&&!N(a[t].trim())){for(;t<a.length&&a[t].trim();)t+=1;for(;t<a.length&&!a[t].trim();)t+=1}return a.slice(t).join(`
`).trim()}const bn=e=>/^https?:\/\//i.test(e??"");function _n({content:e}){return n.jsx("div",{className:"handbook-markdown",children:n.jsx(sn,{remarkPlugins:[an],rehypePlugins:[tn],components:{h1:()=>null,a:({href:s,children:a,...t})=>bn(s)?n.jsx("a",{...t,href:s,target:"_blank",rel:"noreferrer",children:a}):n.jsx("a",{...t,href:s,children:a}),table:({children:s,...a})=>n.jsx("div",{className:"handbook-table-wrap",children:n.jsx("table",{...a,children:s})})},children:e})})}const xn=`# 公司经营功能使用说明
...
`,w="handbook/getting-started",ee=Object.assign({"../../../docs/handbook/company-platform.md":xn,"../../../docs/handbook/faq.md":jn,"../../../docs/handbook/getting-started.md":kn,"../../../docs/handbook/product-lifecycle.md":An,"../../../docs/platform/api-catalog.md":Pn,"../../../docs/platform/architecture.md":Dn,"../../../docs/platform/components.md":vn,"../../../docs/platform/error-codes.md":Sn,"../../../docs/platform/external-platform-map.md":yn,"../../../docs/platform/integrations.md":Tn,"../../../docs/platform/middleware.md":Nn,"../../../docs/product/core-workflows.md":En,"../../../docs/product/data-definitions.md":wn,"../../../docs/product/roles-and-permissions.md":Rn,"../../../docs/superpowers/specs/2026-07-11-permission-settings-design.md":Cn,"../../../docs/superpowers/specs/2026-07-11-task-category-actions-design.md":On,"../../../docs/superpowers/specs/2026-07-11-workflow-task-templates-design.md":Mn,"../../../docs/superpowers/specs/2026-07-13-dashboard-department-todos-design.md":Gn,"../../../docs/superpowers/specs/2026-07-13-demand-created-at-design.md":Ln,"../../../docs/superpowers/specs/2026-07-13-dingtalk-web-login-design.md":Un,"../../../docs/superpowers/specs/2026-07-13-platform-sales-sorting-design.md":Vn,"../../../docs/superpowers/specs/2026-07-15-product-planning-design.md":Yn,"../../../docs/superpowers/specs/2026-07-15-product-progress-schedule-design.md":Fn,"../../../docs/superpowers/specs/2026-07-16-company-strategy-execution-platform-design.md":Kn,"../../../docs/superpowers/specs/2026-07-16-executive-personal-todo-dingtalk-sync-design.md":zn,"../../../docs/superpowers/specs/2026-07-16-strategy-department-incentive-monthly-report-design.md":Bn,"../../../docs/superpowers/specs/2026-07-17-dingtalk-group-executor-selection-design.md":Hn,"../../../docs/superpowers/specs/2026-07-17-dingtalk-todo-recovery-deliverable-crud-design.md":$n,"../../../docs/superpowers/specs/2026-07-17-integration-routing-platform-map-design.md":qn,"../../../docs/superpowers/specs/2026-07-17-planning-card-progress-navigation-design.md":Qn,"../../../docs/superpowers/specs/2026-07-17-platform-handbook-design.md":Wn,"../../../docs/superpowers/specs/2026-07-17-product-grading-boundaries-design.md":Jn,"../../../docs/superpowers/specs/2026-07-17-product-ownership-visibility-design.md":Xn}),U={handbook:0,product:1,platform:2},V={guide:0,product:0,design:1,specification:2,platform:0},R="2026-07-17",B=e=>e.split("/").pop().replace(/\.md$/,""),se=e=>e.match(/^(\d{4}-\d{2}-\d{2})-/)?.[1]??R,te=e=>{const s=B(e);return e.includes("/docs/handbook/")?{slug:`handbook/${s}`,category:"handbook",kind:"guide"}:e.includes("/docs/product/")?{slug:`product/${s}`,category:"product",kind:"product"}:e.includes("/docs/platform/")?{slug:`platform/${s}`,category:"platform",kind:"platform"}:{slug:`product/specs/${s}`,category:"product",kind:"specification"}},ae=Object.entries(ee).map(([e,s])=>{const a=te(e);return E({...a,updatedAt:se(B(e)),content:s})}),ie=[E({slug:"product/product",category:"product",kind:"product",updatedAt:R,content:Zn}),E({slug:"product/design",category:"product",kind:"design",updatedAt:R,content:ne})],y=[...ae,...ie].sort((e,s)=>(e.slug===w?-1:s.slug===w?1:0)||U[e.category]-U[s.category]||V[e.kind]-V[s.kind]||e.title.localeCompare(s.title,"zh-CN")),oe=[{id:"dingtalk",name:"钉钉开放平台",status:"connected",summary:"承载登录、组织通讯录、待办、群聊、日历、文档和钉钉内嵌工作台能力。",capabilities:["身份登录","组织通讯录","待办任务","群聊与成员","日历","文档读取","内嵌工作台"],businessQuestions:["登录或免登失败","找不到人员或部门","待办未创建或未同步","群成员选择异常","钉钉 WebView 行为异常"],keywords:["钉钉","DingTalk","免登","待办","通讯录","群聊","开放平台"],codePaths:["functions/api/dingtalk/**","functions/api/auth/dingtalk/**","src/state/dingtalk*.js","src/features/**/DingTalk*.jsx","server.mjs"],envVars:["DINGTALK_APP_KEY","DINGTALK_APP_SECRET","DINGTALK_CORP_ID","DINGTALK_TOKEN_ENCRYPTION_KEY"],domains:["open.dingtalk.com","api.dingtalk.com","oapi.dingtalk.com"],apiRoutes:["/api/dingtalk/","/api/auth/dingtalk/"],publicDocs:[{label:"钉钉开放平台能力中心",url:"https://open.dingtalk.com/"}],evidence:["functions/api/dingtalk/","functions/api/auth/dingtalk/"],relations:[{platformId:"cloudflare-d1",type:"stores-session-and-org-data",description:"登录会话、用户令牌与组织同步结果使用 D1 持久化。"},{platformId:"cloudflare-pages",type:"hosts-callbacks",description:"Pages Functions 承载登录回调和开放平台 API 适配器。"}]},{id:"kuaimai",name:"快麦开放平台",status:"connected",summary:"按天拉取订单并聚合为产品销售数据，同时保留文件导入校准通道。",capabilities:["订单拉取","会话刷新","销售日聚合","连接状态检查"],businessQuestions:["快麦连接失败","订单同步缺失","销售数据未落库","刷新令牌失败","月度数据校准"],keywords:["快麦","Kuaimai","订单同步","销售数据","ERP","开放平台"],codePaths:["functions/api/kuaimai/**","functions/api/sales.js","src/features/settings/KuaimaiSyncSettings.jsx","src/state/salesStore.js","server.mjs"],envVars:["KUAIMAI_APP_KEY","KUAIMAI_APP_SECRET","KUAIMAI_ACCESS_TOKEN","KUAIMAI_REFRESH_TOKEN"],domains:["open.kuaimai.com","api.kuaimai.com","scm.superboss.cc"],apiRoutes:["/api/kuaimai/","/api/sales"],publicDocs:[{label:"快麦开放平台 API 文档",url:"https://open.kuaimai.com/docs/"}],evidence:["functions/api/kuaimai/","src/features/settings/KuaimaiSyncSettings.jsx"],relations:[{platformId:"cloudflare-d1",type:"stores-sales-aggregates",description:"快麦订单按日聚合后写入销售数据表。"},{platformId:"erp-file-import",type:"reconciled-by",description:"月底可用 ERP 文件整月重导校准退款和缺失数据。"}]},{id:"cloudflare-pages",name:"Cloudflare Pages",status:"connected",summary:"托管 React 应用与 Pages Functions，并提供生产和预览运行边界。",capabilities:["静态站点托管","Pages Functions","生产部署","预览环境","回滚"],businessQuestions:["构建或部署失败","生产页面与本地不一致","Functions 路由异常","预览环境配置缺失"],keywords:["Cloudflare","Pages","Pages Functions","部署","生产环境"],codePaths:["functions/**","scripts/prepare-pages-release.mjs","cloudflare-entry.html","_redirects",".github/workflows/**"],envVars:[],domains:["pages.dev","api.cloudflare.com","dash.cloudflare.com"],apiRoutes:[],publicDocs:[{label:"Cloudflare Pages 文档",url:"https://developers.cloudflare.com/pages/"},{label:"Pages Functions 文档",url:"https://developers.cloudflare.com/pages/functions/"}],evidence:["functions/","scripts/prepare-pages-release.mjs"],relations:[{platformId:"cloudflare-d1",type:"binds",description:"Pages Functions 通过 PRODUCT_FLOW_DB 绑定访问 D1。"}]},{id:"cloudflare-d1",name:"Cloudflare D1",status:"connected",summary:"保存共享业务状态、平台数据、登录会话、组织数据和销售聚合。",capabilities:["共享状态持久化","登录会话","组织数据","销售聚合","平台配置"],businessQuestions:["数据只在本地可见","跨设备状态不同步","数据库绑定缺失","表结构或容量问题"],keywords:["D1","数据库","落库","PRODUCT_FLOW_DB","持久化"],codePaths:["functions/api/state.js","functions/api/platform.js","functions/api/sales.js","functions/api/auth/**","functions/api/dingtalk/org/**"],envVars:["PRODUCT_FLOW_DB"],domains:["api.cloudflare.com","dash.cloudflare.com"],apiRoutes:["/api/state","/api/platform","/api/sales"],publicDocs:[{label:"Cloudflare D1 入门",url:"https://developers.cloudflare.com/d1/get-started/"},{label:"Pages D1 绑定",url:"https://developers.cloudflare.com/pages/functions/bindings/"}],evidence:["functions/api/state.js","functions/api/platform.js","functions/api/sales.js"],relations:[{platformId:"cloudflare-pages",type:"bound-to",description:"D1 通过 Pages Functions 的环境绑定提供服务。"},{platformId:"dingtalk",type:"stores-data-for",description:"保存钉钉会话、组织和用户令牌相关数据。"},{platformId:"kuaimai",type:"stores-data-for",description:"保存快麦同步后的销售聚合数据。"}]},{id:"aliyun",name:"阿里云",status:"integrating",summary:"用于相邻服务、存储或基础设施能力，当前仍需逐项确认账号、资源和生产边界。",capabilities:["云资源","对象存储","OpenAPI","基础设施"],businessQuestions:["阿里云资源属于哪个账号","服务部署在哪里","OpenAPI 权限如何申请","资源与 Cloudflare 的边界"],keywords:["阿里云","Aliyun","Alibaba Cloud","OSS","OpenAPI","云服务器","开放平台"],codePaths:["docs/platform/integrations.md","docs/decisions/**"],envVars:[],domains:["aliyun.com","aliyuncs.com","help.aliyun.com"],apiRoutes:[],publicDocs:[{label:"阿里云帮助中心",url:"https://help.aliyun.com/"},{label:"阿里云 OpenAPI",url:"https://help.aliyun.com/zh/openapi/api-overview/"}],evidence:["docs/platform/integrations.md"],relations:[{platformId:"cloudflare-pages",type:"deployment-boundary",description:"新增云资源前需明确它与现有 Pages 生产环境的职责边界。"}]},{id:"erp-file-import",name:"ERP / 文件导入",status:"integrating",summary:"承接销售明细 Excel 等人工导入，并作为 API 同步的校准和兼容通道。",capabilities:["销售明细导入","字段映射","整月重导","数据校准"],businessQuestions:["Excel 导入失败","字段口径不一致","历史数据补录","API 与文件结果不同"],keywords:["ERP","Excel","文件导入","销售明细","数据校准"],codePaths:["src/features/settings/SalesDataSettings.jsx","src/domain/salesData.js","src/state/salesStore.js","functions/api/sales.js"],envVars:[],domains:[],apiRoutes:["/api/sales"],publicDocs:[],evidence:["src/features/settings/SalesDataSettings.jsx","src/domain/salesData.js"],relations:[{platformId:"kuaimai",type:"reconciles",description:"文件导入用于校准快麦 API 的月度销售结果。"},{platformId:"cloudflare-d1",type:"stores-imports",description:"聚合后的导入结果通过销售 API 写入 D1。"}]},{id:"taobao-open-platform",name:"淘宝开放平台",status:"planned",summary:"计划评估淘宝商品、订单或店铺数据能力，尚未接入。",capabilities:["商品数据","订单数据","店铺数据"],businessQuestions:["淘宝数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],keywords:["淘宝","天猫","Taobao","TOP","开放平台","店铺"],codePaths:[],envVars:[],domains:["open.taobao.com"],apiRoutes:[],publicDocs:[{label:"淘宝开放平台",url:"https://open.taobao.com/"}],evidence:[],relations:[{platformId:"kuaimai",type:"possible-overlap",description:"接入前需确认订单口径是否已经由快麦覆盖。"}]},{id:"pinduoduo-open-platform",name:"拼多多开放平台",status:"planned",summary:"计划评估拼多多商品、订单或店铺数据能力，尚未接入。",capabilities:["商品数据","订单数据","店铺数据"],businessQuestions:["拼多多数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],keywords:["拼多多","Pinduoduo","PDD","开放平台","店铺"],codePaths:[],envVars:[],domains:["open.pinduoduo.com"],apiRoutes:[],publicDocs:[{label:"拼多多开放平台",url:"https://open.pinduoduo.com/"}],evidence:[],relations:[{platformId:"kuaimai",type:"possible-overlap",description:"接入前需确认订单口径是否已经由快麦覆盖。"}]},{id:"xiaohongshu-open-platform",name:"小红书开放平台",status:"planned",summary:"计划评估小红书内容、电商或分享能力，尚未接入。",capabilities:["内容分享","电商数据","应用授权"],businessQuestions:["能否发布或同步内容","电商数据权限","商家自研应用如何授权"],keywords:["小红书","Xiaohongshu","RED","种草","开放平台","内容"],codePaths:[],envVars:[],domains:["xiaohongshu.com","xiaohongshu.apifox.cn"],apiRoutes:[],publicDocs:[{label:"小红书开放平台应用开发",url:"https://xiaohongshu.apifox.cn/doc-2810909"},{label:"小红书分享开放平台",url:"https://agora.xiaohongshu.com/"}],evidence:[],relations:[{platformId:"oceanengine-qianchuan",type:"content-to-advertising",description:"内容与投放协同时需区分自然内容平台和付费投放平台的数据口径。"}]},{id:"oceanengine-qianchuan",name:"巨量引擎 / 巨量千川",status:"planned",summary:"计划评估广告计划、素材和投放报表能力，尚未接入。",capabilities:["广告计划","素材管理","投放报表","商品库"],businessQuestions:["千川投放数据能否自动同步","素材表现如何归因","账户权限如何申请"],keywords:["巨量引擎","巨量千川","千川","Ocean Engine","广告投放","素材","开放平台"],codePaths:[],envVars:[],domains:["open.oceanengine.com","qianchuan.jinritemai.com"],apiRoutes:[],publicDocs:[{label:"巨量引擎商业开放平台",url:"https://open.oceanengine.com/labels"}],evidence:[],relations:[{platformId:"xiaohongshu-open-platform",type:"cross-channel-content",description:"跨渠道素材分析需要区分平台内容与投放数据口径。"}]}],re={platforms:oe},le=["connected","integrating","planned","retired"],de=e=>String(e??"").replace(/\s+/g," ").trim().toLocaleLowerCase("zh-CN");function ce(e,s=[]){const a=new Map((Array.isArray(s)?s:[]).filter(t=>t?.platformId).map(t=>[t.platformId,t]));return(e?.platforms||[]).map(t=>({...t,internal:a.get(t.id)||null}))}function ue(e,{query:s="",status:a="all"}={}){const t=de(s);return(e||[]).filter(r=>a!=="all"&&r.status!==a?!1:t?[r.id,r.name,r.summary,...r.capabilities||[],...r.businessQuestions||[],...r.keywords||[]].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function pe(e){const s=Object.fromEntries(["all",...le].map(a=>[a,0]));for(const a of e||[])s.all+=1,Object.hasOwn(s,a.status)&&(s[a.status]+=1);return s}function me(e,s){const a=new Map((e||[]).map(t=>[t.id,t]));return(s?.relations||[]).flatMap(t=>{const r=a.get(t.platformId);return r?[{...t,platform:r}]:[]})}function ge(e,{now:s=new Date,staleDays:a=180}={}){const t=Date.parse(`${e?.verifiedAt||""}T00:00:00Z`);return Number.isNaN(t)?!0:(s.getTime()-t)/864e5>a}const he="https://product-flow-system.pages.dev/api/platform/v1/integrations";function H(e=""){return["localhost","127.0.0.1","::1"].includes(e)?he:"/api/platform/v1/integrations"}async function $(e){const s=await e.json().catch(()=>({}));if(!e.ok)throw new Error(s.message||`内部平台资料请求失败（HTTP ${e.status}）。`);return s}async function Ie({hostname:e="",fetchImpl:s=fetch}={}){try{const a=await s(H(e),{credentials:"include"}),t=await $(a);return Array.isArray(t.profiles)?t.profiles:[]}catch(a){throw a?.message&&!/failed to fetch|networkerror/i.test(a.message)?a:new Error("无法连接内部平台资料服务。")}}async function fe(e,{hostname:s="",fetchImpl:a=fetch}={}){try{const t=await a(H(s),{method:"PUT",credentials:"include",headers:{"content-type":"application/json"},body:JSON.stringify(e)});return(await $(t)).profile}catch(t){throw t?.message&&!/failed to fetch|networkerror/i.test(t.message)?t:new Error("无法连接内部平台资料服务。")}}const D=[{id:"all",label:"全部"},{id:"connected",label:"已连接"},{id:"integrating",label:"集成中"},{id:"planned",label:"计划中"},{id:"retired",label:"已停用"}],be={consoleUrl:"",accountSubject:"",resourceNamesText:"",environmentsText:"",owner:"",permissionGuide:"",runbook:"",verifiedAt:""};function _e(e){return e?{consoleUrl:e.consoleUrl||"",accountSubject:e.accountSubject||"",resourceNamesText:(e.resourceNames||[]).join(`
`),environmentsText:(e.environments||[]).map(s=>[s.name,s.url,s.notes].join(" | ")).join(`
`),owner:e.owner||"",permissionGuide:e.permissionGuide||"",runbook:e.runbook||"",verifiedAt:e.verifiedAt||""}:be}function xe(e,s){return{platformId:e,consoleUrl:s.consoleUrl,accountSubject:s.accountSubject,resourceNames:s.resourceNamesText.split(/\r?\n/).map(a=>a.trim()).filter(Boolean),environments:s.environmentsText.split(/\r?\n/).flatMap(a=>{const[t="",r="",...o]=a.split("|").map(h=>h.trim());return t?[{name:t,url:r,notes:o.join(" | ")}]:[]}),owner:s.owner,permissionGuide:s.permissionGuide,runbook:s.runbook,verifiedAt:s.verifiedAt}}function je({platform:e,saving:s,error:a,onCancel:t,onSave:r}){const[o,h]=c.useState(()=>_e(e.internal)),u=(d,f)=>h(I=>({...I,[d]:f}));return n.jsxs("form",{className:"integration-profile-editor",onSubmit:d=>{d.preventDefault(),r(xe(e.id,o))},children:[n.jsxs("div",{className:"integration-editor-heading",children:[n.jsxs("div",{children:[n.jsx("strong",{children:"维护内部资料"}),n.jsx("p",{children:"只填写入口、主体、资源和责任信息；凭据必须保存在密钥管理系统。"})]}),n.jsx("button",{className:"icon-action",type:"button","aria-label":"关闭编辑",onClick:t,disabled:s,children:n.jsx(C,{size:16,"aria-hidden":"true"})})]}),n.jsxs("div",{className:"integration-form-grid",children:[n.jsxs("label",{children:[n.jsx("span",{children:"内部控制台 URL"}),n.jsx("input",{type:"url",value:o.consoleUrl,onChange:d=>u("consoleUrl",d.target.value),placeholder:"https://"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"账号主体"}),n.jsx("input",{value:o.accountSubject,onChange:d=>u("accountSubject",d.target.value),placeholder:"公司或业务主体"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"负责人"}),n.jsx("input",{value:o.owner,onChange:d=>u("owner",d.target.value),placeholder:"姓名或岗位"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"最近验证日期"}),n.jsx("input",{type:"date",value:o.verifiedAt,onChange:d=>u("verifiedAt",d.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"应用 / 实例 / 店铺名称"}),n.jsx("textarea",{rows:"3",value:o.resourceNamesText,onChange:d=>u("resourceNamesText",d.target.value),placeholder:"每行一个名称"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"环境"}),n.jsx("textarea",{rows:"3",value:o.environmentsText,onChange:d=>u("environmentsText",d.target.value),placeholder:"生产 | https://example.com/ | 钉钉工作台"}),n.jsx("small",{children:"每行格式：环境名 | HTTPS URL | 说明"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"权限申请路径"}),n.jsx("textarea",{rows:"2",value:o.permissionGuide,onChange:d=>u("permissionGuide",d.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"内部运行手册"}),n.jsx("textarea",{rows:"2",value:o.runbook,onChange:d=>u("runbook",d.target.value),placeholder:"知识库位置或简短操作说明"})]})]}),a?n.jsx("p",{className:"integration-form-error",role:"alert",children:a}):null,n.jsxs("div",{className:"integration-editor-actions",children:[n.jsx("button",{className:"btn",type:"button",onClick:t,disabled:s,children:"取消"}),n.jsx("button",{className:"btn primary",type:"submit",disabled:s,children:s?"正在保存…":"保存内部资料"})]})]})}function ke({platform:e,loading:s}){if(s)return n.jsxs("div",{className:"integration-profile-loading","aria-busy":"true",children:[n.jsx("span",{}),n.jsx("span",{}),n.jsx("span",{}),n.jsx("small",{children:"正在读取内部资料…"})]});const a=e.internal;return a?n.jsxs("div",{className:"integration-profile-content",children:[ge(a)?n.jsxs("p",{className:"integration-stale",children:[n.jsx(F,{size:15,"aria-hidden":"true"}),"资料超过 180 天未验证，请联系负责人复核。"]}):null,n.jsxs("dl",{children:[n.jsxs("div",{children:[n.jsx("dt",{children:"账号主体"}),n.jsx("dd",{children:a.accountSubject||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"负责人"}),n.jsx("dd",{children:a.owner||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"最近验证"}),n.jsx("dd",{children:a.verifiedAt||"未验证"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"维护人"}),n.jsx("dd",{children:a.updatedBy||"未知"})]})]}),a.consoleUrl?n.jsxs("a",{className:"integration-console-link",href:a.consoleUrl,target:"_blank",rel:"noreferrer",children:["打开内部控制台 ",n.jsx(K,{size:14,"aria-hidden":"true"})]}):null,a.resourceNames?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"应用 / 实例 / 店铺"}),n.jsx("ul",{children:a.resourceNames.map(t=>n.jsx("li",{children:t},t))})]}):null,a.environments?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"环境"}),n.jsx("ul",{children:a.environments.map(t=>n.jsxs("li",{children:[n.jsx("b",{children:t.name}),t.url?n.jsx("a",{href:t.url,target:"_blank",rel:"noreferrer",children:t.url}):null,t.notes?n.jsx("span",{children:t.notes}):null]},`${t.name}-${t.url}`))})]}):null,a.permissionGuide?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"权限申请路径"}),n.jsx("p",{children:a.permissionGuide})]}):null,a.runbook?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"内部运行手册"}),n.jsx("p",{children:a.runbook})]}):null]}):n.jsxs("div",{className:"integration-profile-empty",children:[n.jsx(un,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料尚未维护"}),n.jsx("p",{children:"平台管理员可补充控制台、账号主体、负责人和运行手册。"})]})]})}function Ae({sessionUser:e}){const[s,a]=c.useState([]),[t,r]=c.useState("loading"),[o,h]=c.useState(""),[u,d]=c.useState(""),[f,I]=c.useState("all"),[x,j]=c.useState("dingtalk"),[k,l]=c.useState(!1),[p,A]=c.useState(!1),[q,_]=c.useState(""),[M,S]=c.useState("");c.useEffect(()=>{let i=!0;return Ie({hostname:window.location.hostname}).then(g=>{i&&(a(g),r("ready"))}).catch(g=>{i&&(h(g?.message||"内部资料暂不可用。"),r("error"))}),()=>{i=!1}},[]);const b=c.useMemo(()=>ce(re,s),[s]),Q=c.useMemo(()=>pe(b),[b]),P=c.useMemo(()=>ue(b,{query:u,status:f}),[b,u,f]),m=P.find(i=>i.id===x)||P[0]||null,G=c.useMemo(()=>me(b,m),[b,m]),W=rn(e)&&e?.role!=="readonly",J=i=>{j(i),l(!1),_(""),S("")},X=async i=>{A(!0),_(""),S("");try{const g=await fe(i,{hostname:window.location.hostname});a(Z=>[...Z.filter(nn=>nn.platformId!==g.platformId),g]),l(!1),S("内部资料已保存。公开注册表未被修改。")}catch(g){_(g?.message||"内部平台资料保存失败。")}finally{A(!1)}};return n.jsxs("section",{className:"integration-map","aria-label":"外部平台地图",children:[t==="error"?n.jsxs("div",{className:"integration-degraded",role:"status",children:[n.jsx(F,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料暂不可用"}),n.jsxs("p",{children:[o," 公开平台资料仍可正常查看。"]})]})]}):null,n.jsxs("div",{className:"integration-map-toolbar",children:[n.jsxs("label",{className:"integration-map-search",children:[n.jsx(T,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索平台、能力或问题"}),n.jsx("input",{type:"search",value:u,onChange:i=>d(i.target.value),placeholder:"搜索平台、能力或问题"}),u?n.jsx("button",{type:"button","aria-label":"清除平台搜索",onClick:()=>d(""),children:n.jsx(C,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"integration-status-filters","aria-label":"平台状态筛选",children:D.map(i=>n.jsxs("button",{type:"button","aria-pressed":f===i.id,className:f===i.id?"active":"",onClick:()=>I(i.id),children:[i.label,n.jsx("span",{children:Q[i.id]})]},i.id))})]}),P.length?n.jsxs("div",{className:"integration-map-workspace",children:[n.jsx("nav",{className:"integration-platform-list","aria-label":"外部平台",children:P.map(i=>n.jsxs("button",{type:"button",className:m?.id===i.id?"active":"","aria-current":m?.id===i.id?"true":void 0,onClick:()=>J(i.id),children:[n.jsx("span",{className:`integration-status-dot ${i.status}`,"aria-hidden":"true"}),n.jsxs("span",{children:[n.jsx("strong",{children:i.name}),n.jsx("small",{children:i.capabilities.slice(0,2).join(" · ")})]}),n.jsx("em",{className:`integration-status-label ${i.status}`,children:D.find(g=>g.id===i.status)?.label})]},i.id))}),n.jsxs("div",{className:"integration-platform-detail",children:[n.jsxs("header",{className:"integration-detail-header",children:[n.jsxs("div",{children:[n.jsxs("div",{className:"integration-detail-title",children:[n.jsx("h2",{children:m.name}),n.jsx("span",{className:`integration-status-label ${m.status}`,children:D.find(i=>i.id===m.status)?.label})]}),n.jsx("p",{children:m.summary})]}),W&&!k?n.jsxs("button",{className:"btn compact",type:"button",onClick:()=>{l(!0),_("")},children:[n.jsx(ln,{size:14,"aria-hidden":"true"}),"维护内部资料"]}):null]}),M?n.jsxs("p",{className:"integration-save-success",role:"status",children:[n.jsx(dn,{size:15,"aria-hidden":"true"}),M]}):null,n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"能力与常见问题"}),n.jsx("div",{className:"integration-capabilities",children:m.capabilities.map(i=>n.jsx("span",{children:i},i))}),n.jsx("ul",{className:"integration-question-list",children:m.businessQuestions.map(i=>n.jsx("li",{children:i},i))})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"关联关系"}),G.length?n.jsx("ul",{className:"integration-relation-list",children:G.map(i=>n.jsxs("li",{children:[n.jsx(cn,{size:15,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:i.platform.name}),n.jsx("p",{children:i.description})]}),n.jsx("span",{children:D.find(g=>g.id===i.platform.status)?.label})]},`${i.platform.id}-${i.type}`))}):n.jsx("p",{children:"当前没有登记的一层关联平台。"})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"官方公开文档"}),m.publicDocs.length?n.jsx("div",{className:"integration-public-links",children:m.publicDocs.map(i=>n.jsxs("a",{href:i.url,target:"_blank",rel:"noreferrer",children:[i.label,n.jsx(K,{size:14,"aria-hidden":"true"})]},i.url))}):n.jsx("p",{children:"该能力是内部文件导入边界，没有独立的外部官方文档。"})]}),n.jsxs("section",{className:"integration-detail-section integration-private-section",children:[n.jsxs("div",{className:"integration-section-heading",children:[n.jsx("h3",{children:"公司内部资料"}),n.jsx("span",{children:"登录后可见"})]}),k?n.jsx(je,{platform:m,saving:p,error:q,onCancel:()=>{l(!1),_("")},onSave:X},m.id):n.jsx(ke,{platform:m,loading:t==="loading"})]})]})]}):n.jsxs("div",{className:"integration-map-empty",children:[n.jsx(T,{size:22,"aria-hidden":"true"}),n.jsx("strong",{children:"没有匹配的平台"}),n.jsx("p",{children:"换一个关键词，或清除状态筛选查看全部平台。"}),n.jsx("button",{className:"btn",type:"button",onClick:()=>{d(""),I("all")},children:"查看全部平台"})]})]})}const Pe=Object.fromEntries(z.map(e=>[e.id,e.label])),Y={guide:"使用说明",product:"产品说明",design:"设计书",specification:"设计规格",platform:"平台能力"},De=e=>Object.entries(Pe).map(([s,a])=>({category:s,label:a,documents:e.filter(t=>t.category===s)})).filter(s=>s.documents.length);function Ee({selectedSlug:e,onSelectDocument:s,sessionUser:a}){const[t,r]=c.useState(""),o=hn(y,e,w),[h,u]=c.useState(()=>o?.category??"handbook"),d=c.useMemo(()=>gn(y,{query:t,category:h}),[h,t]),f=c.useMemo(()=>De(d),[d]),I=o?.slug==="platform/external-platform-map",x=c.useMemo(()=>In(o?.content),[o]);c.useEffect(()=>{e&&o?.category&&u(o.category)},[o?.category,e]);const j=l=>{if(u(l),o?.category!==l){const p=y.find(A=>A.category===l);p&&s?.(p.slug)}},k=(l,p)=>{l.preventDefault(),document.getElementById(p)?.scrollIntoView({behavior:"smooth",block:"start"})};return n.jsxs("section",{className:"page handbook-page",children:[n.jsx(on,{title:"说明书",description:"公司的工作方法、产品定义、设计决策与共享平台能力，以仓库文档为准。"}),n.jsxs("div",{className:"handbook-tools",role:"search",children:[n.jsxs("label",{className:"handbook-search",children:[n.jsx(T,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索说明书"}),n.jsx("input",{type:"search",value:t,onChange:l=>r(l.target.value),placeholder:"搜索说明书"}),t?n.jsx("button",{type:"button","aria-label":"清除搜索",onClick:()=>r(""),children:n.jsx(C,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"handbook-filters","aria-label":"说明书分类",children:z.map(l=>n.jsx("button",{type:"button",className:h===l.id?"active":"","aria-pressed":h===l.id,onClick:()=>j(l.id),children:l.label},l.id))})]}),d.length&&o?n.jsxs("div",{className:`handbook-workspace${I?" platform-map-open":""}`,children:[n.jsx("nav",{className:"handbook-catalog","aria-label":"说明书目录",children:f.map(l=>n.jsxs("section",{className:"handbook-catalog-group","data-category":l.category,children:[n.jsx("h2",{children:l.label}),n.jsx("div",{className:"handbook-document-list",children:l.documents.map(p=>n.jsxs("button",{type:"button",className:o.slug===p.slug?"active":"","aria-current":o.slug===p.slug?"page":void 0,onClick:()=>s?.(p.slug),children:[n.jsx("strong",{children:p.title}),n.jsx("small",{children:Y[p.kind]??p.kind})]},p.slug))})]},l.category))}),n.jsxs("article",{className:`handbook-article${I?" handbook-article-platform-map":""}`,children:[n.jsxs("header",{className:"handbook-document-header",children:[n.jsxs("div",{className:"handbook-document-kind",children:[n.jsx(L,{size:15,"aria-hidden":"true"}),Y[o.kind]??o.kind]}),n.jsx("h1",{children:o.title}),n.jsx("p",{children:o.summary}),n.jsxs("time",{dateTime:o.updatedAt,children:["更新于 ",o.updatedAt]})]}),I?n.jsx(Ae,{sessionUser:a}):n.jsx(_n,{content:fn(o.content)})]}),I?null:n.jsxs("aside",{className:"handbook-toc","aria-label":"本页目录",children:[n.jsx("strong",{children:"本页目录"}),x.length?n.jsx("ol",{children:x.map(l=>n.jsx("li",{className:`level-${l.level}`,children:n.jsx("a",{href:`#${l.id}`,onClick:p=>k(p,l.id),children:l.title})},`${l.id}-${l.level}`))}):n.jsx("small",{children:"本页没有分节标题"})]})]}):n.jsxs("div",{className:"handbook-empty",children:[n.jsx(L,{size:24,"aria-hidden":"true"}),n.jsx("strong",{children:"没有找到匹配的说明"}),n.jsx("span",{children:"换一个关键词，或返回使用手册查看现有文档。"}),n.jsx("button",{type:"button",className:"btn",onClick:()=>{r(""),j("handbook")},children:"返回使用手册"})]})]})}export{Ee as default};
