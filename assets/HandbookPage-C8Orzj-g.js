import{j as n,r as d}from"./react-vendor-CgER1fZB.js";import{B as ln,M as cn,a as dn,r as pn}from"./markdown-vendor-BtF6cZKv.js";import{P as un}from"./PageHeader-BF8LF3r1.js";import{m as q}from"./index-BDwHncMt.js";import{T as O,aj as y,X as V,aa as mn,a8 as _n,ah as In,ac as Q,D as z,aJ as $,b as J,R as An,aN as K,av as gn,c as fn,f as hn,Q as B}from"./icons-vendor-khCmWx_w.js";const X=[{id:"handbook",label:"使用手册"},{id:"product",label:"产品与设计"},{id:"platform",label:"平台能力"}],b=s=>String(s??"").replace(/\s+/g," ").trim(),L=s=>/^#{1,6}\s|^(```|~~~|>|[-*+]\s|\d+[.)]\s|\|)/.test(s),G=s=>b(s.replace(/!\[([^\]]*)\]\([^)]*\)/g,"$1").replace(/\[([^\]]+)\]\([^)]*\)/g,"$1").replace(/[`*_~]/g,"")),vn=s=>{const e=String(s??"").match(/^#\s+(.+?)\s*#*\s*$/m);return e?G(e[1]):"未命名说明"},En=s=>{const e=String(s??"").split(/\r?\n/);for(let a=0;a<e.length;a+=1){const t=e[a].trim();if(!t||L(t))continue;const l=[t];for(;e[a+1]?.trim()&&!L(e[a+1].trim());)l.push(e[a+1].trim()),a+=1;return G(l.join(" "))}return"暂无摘要"};function w(s){const e=String(s.content??"");return{...s,content:e,title:b(s.title)||vn(e),summary:b(s.summary)||En(e)}}function Dn(s,{query:e="",category:a="all"}={}){const t=b(e).toLocaleLowerCase("zh-CN");return s.filter(l=>a&&a!=="all"&&l.category!==a?!1:t?[l.title,l.summary,l.content].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function Pn(s,e,a){return s.length?s.find(t=>t.slug===e)??s.find(t=>t.slug===a)??s[0]:null}function Tn(s){const e=new ln,a=[],t=/^(#{2,3})\s+(.+?)\s*#*\s*$/gm;let l;for(;(l=t.exec(String(s??"")))!==null;){const o=G(l[2]);a.push({level:l[1].length,title:o,id:e.slug(o)})}return a}function Nn(s){const e=String(s??""),a=e.split(/\r?\n/);let t=0;for(;t<a.length&&!a[t].trim();)t+=1;if(!/^#\s+/.test(a[t]?.trim()??""))return e;for(t+=1;t<a.length&&!a[t].trim();)t+=1;if(a[t]?.trim()&&!L(a[t].trim())){for(;t<a.length&&a[t].trim();)t+=1;for(;t<a.length&&!a[t].trim();)t+=1}return a.slice(t).join(`
`).trim()}const Sn=s=>/^https?:\/\//i.test(s??"");function Rn({content:s}){return n.jsx("div",{className:"handbook-markdown",children:n.jsx(cn,{remarkPlugins:[pn],rehypePlugins:[dn],components:{h1:()=>null,a:({href:e,children:a,...t})=>Sn(e)?n.jsx("a",{...t,href:e,target:"_blank",rel:"noreferrer",children:a}):n.jsx("a",{...t,href:e,children:a}),table:({children:e,...a})=>n.jsx("div",{className:"handbook-table-wrap",children:n.jsx("table",{...a,children:e})})},children:s})})}const Cn=`# 公司经营功能使用说明
...
承担订单明细读取、日销售聚合和共享商品主数据读取。签名和密钥仅在服务端使用。订单按日期和页码执行，保留订单创建时间；商品按 \`item.list.query\` 全部分页执行，只有完整批次才写入目录。当前授权的商品列表响应不单独返回条形码，必须与商品档案导出按主/规格商家编码合并，不能把 API 缺失解释为 ERP 删除。
...
`,U="handbook/getting-started",De=Object.assign({"../../../docs/handbook/company-platform.md":Cn,"../../../docs/handbook/faq.md":On,"../../../docs/handbook/getting-started.md":jn,"../../../docs/handbook/product-lifecycle.md":bn,"../../../docs/platform/api-catalog.md":xn,"../../../docs/platform/architecture.md":kn,"../../../docs/platform/browser-market-collection.md":yn,"../../../docs/platform/components.md":Ln,"../../../docs/platform/environment-parity-skill.md":wn,"../../../docs/platform/environment-readiness.md":Un,"../../../docs/platform/error-codes.md":Mn,"../../../docs/platform/external-platform-map.md":Vn,"../../../docs/platform/integrations.md":Gn,"../../../docs/platform/middleware.md":Fn,"../../../docs/product/core-workflows.md":Kn,"../../../docs/product/data-definitions.md":Bn,"../../../docs/product/roles-and-permissions.md":Yn,"../../../docs/superpowers/specs/2026-07-11-permission-settings-design.md":Wn,"../../../docs/superpowers/specs/2026-07-11-task-category-actions-design.md":Hn,"../../../docs/superpowers/specs/2026-07-11-workflow-task-templates-design.md":qn,"../../../docs/superpowers/specs/2026-07-13-dashboard-department-todos-design.md":Qn,"../../../docs/superpowers/specs/2026-07-13-demand-created-at-design.md":zn,"../../../docs/superpowers/specs/2026-07-13-dingtalk-web-login-design.md":$n,"../../../docs/superpowers/specs/2026-07-13-platform-sales-sorting-design.md":Jn,"../../../docs/superpowers/specs/2026-07-15-product-planning-design.md":Xn,"../../../docs/superpowers/specs/2026-07-15-product-progress-schedule-design.md":Zn,"../../../docs/superpowers/specs/2026-07-16-company-strategy-execution-platform-design.md":ne,"../../../docs/superpowers/specs/2026-07-16-executive-personal-todo-dingtalk-sync-design.md":ee,"../../../docs/superpowers/specs/2026-07-16-strategy-department-incentive-monthly-report-design.md":se,"../../../docs/superpowers/specs/2026-07-17-dingtalk-group-executor-selection-design.md":ae,"../../../docs/superpowers/specs/2026-07-17-dingtalk-todo-recovery-deliverable-crud-design.md":te,"../../../docs/superpowers/specs/2026-07-17-integration-routing-platform-map-design.md":ie,"../../../docs/superpowers/specs/2026-07-17-planning-card-progress-navigation-design.md":oe,"../../../docs/superpowers/specs/2026-07-17-platform-handbook-design.md":re,"../../../docs/superpowers/specs/2026-07-17-product-grading-boundaries-design.md":le,"../../../docs/superpowers/specs/2026-07-17-product-ownership-visibility-design.md":ce,"../../../docs/superpowers/specs/2026-07-17-strategy-crud-design.md":de,"../../../docs/superpowers/specs/2026-07-17-strategy-result-commitment-drilldown-design.md":pe,"../../../docs/superpowers/specs/2026-07-17-strategy-rule-strip-removal-design.md":ue,"../../../docs/superpowers/specs/2026-07-17-supply-chain-left-navigation-design.md":me,"../../../docs/superpowers/specs/2026-07-17-supply-chain-management-app-design.md":_e,"../../../docs/superpowers/specs/2026-07-17-supply-chain-real-data-design.md":Ie,"../../../docs/superpowers/specs/2026-07-18-data-center-app-design.md":Ae,"../../../docs/superpowers/specs/2026-07-19-collapsible-app-navigation-design.md":ge,"../../../docs/superpowers/specs/2026-07-20-connector-configuration-simplification-design.md":fe,"../../../docs/superpowers/specs/2026-07-20-navigation-product-catalog-load-fix-design.md":he}),Y={handbook:0,product:1,platform:2},W={guide:0,product:0,design:1,specification:2,platform:0},M="2026-07-17",Z=s=>s.split("/").pop().replace(/\.md$/,""),Pe=s=>s.match(/^(\d{4}-\d{2}-\d{2})-/)?.[1]??M,Te=s=>{const e=Z(s);return s.includes("/docs/handbook/")?{slug:`handbook/${e}`,category:"handbook",kind:"guide"}:s.includes("/docs/product/")?{slug:`product/${e}`,category:"product",kind:"product"}:s.includes("/docs/platform/")?{slug:`platform/${e}`,category:"platform",kind:"platform"}:{slug:`product/specs/${e}`,category:"product",kind:"specification"}},Ne=Object.entries(De).map(([s,e])=>{const a=Te(s);return w({...a,updatedAt:Pe(Z(s)),content:e})}),Se=[w({slug:"product/product",category:"product",kind:"product",updatedAt:M,content:ve}),w({slug:"product/design",category:"product",kind:"design",updatedAt:M,content:Ee})],k=[...Ne,...Se].sort((s,e)=>(s.slug===U?-1:e.slug===U?1:0)||Y[s.category]-Y[e.category]||W[s.kind]-W[e.kind]||s.title.localeCompare(e.title,"zh-CN")),Re=JSON.parse('[{"id":"dingtalk","name":"钉钉开放平台","status":"connected","summary":"承载登录、组织通讯录、待办、群聊、日历、文档、供应链文件快照和钉钉内嵌工作台能力。","capabilities":["身份登录","组织通讯录","待办任务","群聊与成员","日历","文档读取","采购与付款审批同步","供应链文件快照","内嵌工作台","平台连接配置"],"businessQuestions":["登录或免登失败","找不到人员或部门","待办未创建或未同步","本地如何执行真实待办与日历动作","群成员选择异常","供应链文件快照未导入","钉钉 WebView 行为异常"],"keywords":["钉钉","DingTalk","免登","待办","通讯录","群聊","开放平台"],"codePaths":["functions/api/dingtalk/**","functions/api/auth/dingtalk/**","functions/api/supply-chain/approvals/sync.js","functions/api/platform/v1/collaboration-items/**/dingtalk.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","src/state/dingtalk*.js","src/features/**/DingTalk*.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","scripts/import-dingtalk-supply-inventory.mjs","scripts/lib/dingtalkSupplyInventory.mjs","server.mjs"],"envVars":["DINGTALK_APP_KEY","DINGTALK_APP_SECRET","DINGTALK_CORP_ID","DINGTALK_TOKEN_ENCRYPTION_KEY"],"domains":["open.dingtalk.com","api.dingtalk.com","oapi.dingtalk.com"],"apiRoutes":["/api/dingtalk/","/api/auth/dingtalk/","/api/supply-chain/approvals/sync","/api/platform/v1/collaboration-items/:id/dingtalk","/api/platform/v1/platform-connections"],"publicDocs":[{"label":"钉钉开放平台能力中心","url":"https://open.dingtalk.com/"}],"evidence":["functions/api/dingtalk/","functions/api/auth/dingtalk/","functions/api/supply-chain/approvals/sync.js","functions/api/platform/v1/collaboration-items/[id]/dingtalk.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","src/features/data-center/PlatformConnectionsWorkspace.jsx","scripts/import-dingtalk-supply-inventory.mjs","scripts/lib/dingtalkSupplyInventory.mjs"],"relations":[{"platformId":"cloudflare-d1","type":"stores-session-and-org-data","description":"登录会话、用户令牌与组织同步结果使用 D1 持久化。"},{"platformId":"cloudflare-pages","type":"hosts-callbacks","description":"Pages Functions 承载登录回调和开放平台 API 适配器。"}]},{"id":"kuaimai","name":"快麦开放平台","status":"connected","summary":"按天拉取订单并聚合销售，同时分页读取 ERP 商品主数据并与商品档案文件互补合并。","capabilities":["订单拉取","商品目录同步","会话刷新","销售日聚合","连接状态检查","平台连接配置"],"businessQuestions":["快麦连接失败","订单同步缺失","ERP 商品或 69 码未同步","销售数据未落库","本地如何触发真实同步","刷新令牌失败","月度数据校准","API 与商品档案覆盖不同"],"keywords":["快麦","Kuaimai","订单同步","销售数据","ERP","开放平台"],"codePaths":["functions/api/kuaimai/**","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/**","functions/api/sales.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","src/domain/productCatalog.js","src/state/ProductCatalogProvider.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","src/features/settings/KuaimaiSyncSettings.jsx","src/state/salesStore.js","server.mjs"],"envVars":["KUAIMAI_APP_KEY","KUAIMAI_APP_SECRET","KUAIMAI_ACCESS_TOKEN","KUAIMAI_REFRESH_TOKEN"],"domains":["open.kuaimai.com","api.kuaimai.com","scm.superboss.cc"],"apiRoutes":["/api/kuaimai/","/api/sales","/api/platform/v1/platform-connections","/api/platform/v1/product-catalog","/api/platform/v1/product-catalog/import","/api/platform/v1/product-catalog/sync/kuaimai"],"publicDocs":[{"label":"快麦开放平台 API 文档","url":"https://open.kuaimai.com/docs/"}],"evidence":["functions/api/kuaimai/","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/product-catalog/sync/kuaimai.js","src/domain/productCatalog.js","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/data-center/PlatformConnectionsWorkspace.jsx","src/features/settings/KuaimaiSyncSettings.jsx"],"relations":[{"platformId":"cloudflare-d1","type":"stores-sales-and-product-catalog","description":"快麦订单日聚合与共享商品目录分别写入 D1。"},{"platformId":"erp-file-import","type":"reconciled-by","description":"销售文件校准月度事实，商品档案文件补齐 API 未返回的规格、69 码和供应商字段。"}]},{"id":"cloudflare-pages","name":"Cloudflare Pages","status":"connected","summary":"托管 React 应用与 Pages Functions，并提供生产和预览运行边界。","capabilities":["静态站点托管","Pages Functions","生产部署","预览环境","本地线上账号运行","回滚","环境就绪检查","生产数据网关","凭证加密服务","加密平台连接","用户洞察共享 API","共享数据口径"],"businessQuestions":["构建或部署失败","生产页面与本地不一致","Functions 路由异常","预览环境配置缺失","测试环境与生产配置漂移","本地如何使用真实线上账号、数据与外部动作"],"keywords":["Cloudflare","Pages","Pages Functions","部署","生产环境"],"codePaths":["functions/**","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/data-standards/**","functions/api/platform/v1/_shared/dataStandards*.js","src/state/deploymentRecovery.js","scripts/prepare-pages-build.mjs","scripts/prepare-pages-release.mjs","scripts/check-deployed-readiness.mjs","cloudflare-entry.html","404.html","public/404.html","_redirects","wrangler.toml",".github/workflows/**"],"envVars":["PLATFORM_CREDENTIAL_MASTER_KEY","LOCAL_ONLINE_ACCOUNT_MODE","PRODUCTION_DATA_ACCESS_TOKEN","AI_ASSISTANT_ENABLED","LINGSUAN_API_KEY","LINGSUAN_ACTOR_AUTHORIZATION","VITE_DATA_CENTER_LEGACY_OVERVIEW_ROLLBACK"],"domains":["pages.dev","api.cloudflare.com","dash.cloudflare.com"],"apiRoutes":["/api/platform/v1/environment-readiness","/api/platform/v1/platform-connections","/api/platform/v1/credential-vault","/api/platform/v1/data-standards","/api/platform/v1/production-write-session","/api/platform/v1/production-data/","/api/platform/v1/user-insights","/api/platform/v1/user-insights/","/api/platform/v1/ai/"],"publicDocs":[{"label":"Cloudflare Pages 文档","url":"https://developers.cloudflare.com/pages/"},{"label":"Pages Functions 文档","url":"https://developers.cloudflare.com/pages/functions/"}],"evidence":["functions/","functions/api/platform/v1/platform-connections.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/v1/_shared/dataStandardsStorage.js","src/state/deploymentRecovery.js","docs/platform/architecture.md","scripts/prepare-pages-build.mjs","scripts/prepare-pages-release.mjs","wrangler.toml"],"relations":[{"platformId":"cloudflare-d1","type":"binds","description":"Pages Functions 通过 PRODUCT_FLOW_DB 绑定访问 D1。"}]},{"id":"cloudflare-d1","name":"Cloudflare D1","status":"connected","summary":"保存共享业务状态、平台数据、登录会话、组织数据、销售聚合、共享商品目录、用户洞察、货流事实、数据中心、加密凭证、店铺运营、人事绩效、跨 App 协同和 AI 安全元数据。","capabilities":["共享状态持久化","登录会话","组织数据","销售聚合","共享商品目录","用户洞察标准事实","用户洞察部门规则","采集设备令牌哈希","货流事件与指标","平台配置","数据中心元数据","版本化数据口径与计算结果","加密凭证密文与审计","店铺运营记录","人事核心记录","绩效记录","跨 App 协同","AI Provider 元数据","AI 外发策略","AI 无内容审计","生产写入审计","写前快照","加密平台连接"],"businessQuestions":["数据只在本地可见","跨设备状态不同步","数据库绑定缺失","表结构或容量问题","用户洞察采集结果未落库","货流事实或指标未落库","人事数据表是否就绪","跨部门事项如何留痕","测试账号如何受控写生产数据","生产写入如何回滚"],"keywords":["D1","数据库","落库","PRODUCT_FLOW_DB","持久化"],"codePaths":["functions/api/state.js","functions/api/platform.js","functions/api/supply-chain.js","functions/api/supply-chain/**","functions/api/platform/v1/goods-flow/**","functions/api/sales.js","functions/api/data-center.js","functions/api/data-center/**","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/**","functions/api/ecommerce-operations.js","functions/api/ecommerce-operations/**","functions/api/performance-management.js","functions/api/performance-management/**","functions/api/hr-management/**","functions/api/auth/**","functions/api/dingtalk/org/**","functions/api/platform/_shared/productionDataAccess.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/credential*.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/v1/credential-vault.js","functions/api/platform/v1/credential-vault/**","functions/api/platform/v1/data-standards/**","functions/api/platform/v1/_shared/dataStandards*.js","functions/api/platform/v1/production-data/**","functions/api/platform/v1/collaboration-items/**","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/**","functions/api/platform/v1/ai/**","functions/api/platform/v1/_shared/collaborationStorage.js","migrations/**","migrations/0002_hr_management_core.sql","migrations/0003_product_catalog.sql","migrations/0003_platform_credentials.sql","migrations/0003_data_center_credentials.sql","migrations/0004_data_standards.sql","migrations/0005_user_insights.sql","migrations/0005_goods_flow_core.sql"],"envVars":["PRODUCT_FLOW_DB"],"domains":["api.cloudflare.com","dash.cloudflare.com"],"apiRoutes":["/api/state","/api/platform","/api/supply-chain","/api/platform/v1/goods-flow/","/api/sales","/api/data-center","/api/platform/v1/product-catalog","/api/platform/v1/product-catalog/import","/api/platform/v1/product-catalog/sync/kuaimai","/api/ecommerce-operations","/api/performance-management","/api/hr-management","/api/platform/v1/environment-readiness","/api/platform/v1/platform-connections","/api/platform/v1/credential-vault","/api/platform/v1/data-standards","/api/platform/v1/production-write-session","/api/platform/v1/production-data/","/api/platform/v1/collaboration-items","/api/platform/v1/user-insights","/api/platform/v1/user-insights/","/api/platform/v1/ai/"],"publicDocs":[{"label":"Cloudflare D1 入门","url":"https://developers.cloudflare.com/d1/get-started/"},{"label":"Pages D1 绑定","url":"https://developers.cloudflare.com/pages/functions/bindings/"}],"evidence":["functions/api/state.js","functions/api/platform.js","functions/api/supply-chain.js","functions/api/supply-chain/","functions/api/platform/v1/goods-flow/","functions/api/sales.js","functions/api/data-center.js","functions/api/data-center/","functions/api/platform/v1/product-catalog.js","functions/api/platform/v1/product-catalog/","functions/api/ecommerce-operations.js","functions/api/ecommerce-operations/","functions/api/performance-management.js","functions/api/performance-management/","functions/api/hr-management/","functions/api/platform/_shared/productionDataAccess.js","functions/api/platform/_shared/platformCredentials.js","functions/api/platform/_shared/credentialVaultStorage.js","functions/api/platform/_shared/credentialCrypto.js","functions/api/platform/v1/platform-connections.js","functions/api/platform/v1/credential-vault/","functions/api/platform/v1/_shared/collaborationStorage.js","functions/api/platform/v1/_shared/dataStandardsStorage.js","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/","functions/api/platform/v1/ai/","migrations/0001_production_data_access.sql","migrations/0002_business_data_apps.sql","migrations/0002_collaboration_execution.sql","migrations/0002_hr_management_core.sql","migrations/0003_product_catalog.sql","migrations/0003_platform_credentials.sql","migrations/0003_data_center_credentials.sql","migrations/0003_company_ai_assistant.sql","migrations/0004_data_standards.sql","migrations/0004_company_ai_skills.sql","migrations/0005_user_insights.sql","migrations/0005_goods_flow_core.sql"],"relations":[{"platformId":"cloudflare-pages","type":"bound-to","description":"D1 通过 Pages Functions 的环境绑定提供服务。"},{"platformId":"dingtalk","type":"stores-data-for","description":"保存钉钉会话、组织和用户令牌相关数据。"},{"platformId":"kuaimai","type":"stores-data-for","description":"保存快麦同步后的销售聚合与共享商品目录。"}]},{"id":"aliyun","name":"阿里云","status":"integrating","summary":"用于相邻服务、存储或基础设施能力，当前仍需逐项确认账号、资源和生产边界。","capabilities":["云资源","对象存储","OpenAPI","基础设施"],"businessQuestions":["阿里云资源属于哪个账号","服务部署在哪里","OpenAPI 权限如何申请","资源与 Cloudflare 的边界"],"keywords":["阿里云","Aliyun","Alibaba Cloud","OSS","OpenAPI","云服务器","开放平台"],"codePaths":["docs/platform/integrations.md","docs/decisions/**"],"envVars":[],"domains":["aliyun.com","aliyuncs.com","help.aliyun.com"],"apiRoutes":[],"publicDocs":[{"label":"阿里云帮助中心","url":"https://help.aliyun.com/"},{"label":"阿里云 OpenAPI","url":"https://help.aliyun.com/zh/openapi/api-overview/"}],"evidence":["docs/platform/integrations.md"],"relations":[{"platformId":"cloudflare-pages","type":"deployment-boundary","description":"新增云资源前需明确它与现有 Pages 生产环境的职责边界。"}]},{"id":"erp-file-import","name":"ERP / 文件导入","status":"integrating","summary":"承接销售明细、ERP 商品档案、库存快照和月度盘点文件，作为 API 同步的校准、补齐和兼容通道。","capabilities":["销售明细导入","商品档案导入","ERP 库存快照导入","月度盘点导入","GB18030 CSV","字段映射","整月重导","数据校准"],"businessQuestions":["Excel 或 CSV 导入失败","商品 69 码或供应商字段缺失","库存或盘点字段口径不一致","历史数据补录","API 与文件结果不同"],"keywords":["ERP","Excel","文件导入","销售明细","数据校准"],"codePaths":["src/features/settings/SalesDataSettings.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/supply-chain/InventoryWorkspace.jsx","src/domain/salesData.js","src/domain/productCatalog.js","src/domain/xlsxLite.js","src/domain/supplyChain.js","src/state/salesStore.js","functions/api/sales.js","functions/api/platform/v1/product-catalog/import.js","functions/api/platform/v1/goods-flow/imports.js"],"envVars":[],"domains":[],"apiRoutes":["/api/sales","/api/platform/v1/product-catalog/import","/api/platform/v1/goods-flow/imports"],"publicDocs":[],"evidence":["src/features/settings/SalesDataSettings.jsx","src/features/data-center/ProductCatalogWorkspace.jsx","src/features/supply-chain/InventoryWorkspace.jsx","src/domain/salesData.js","src/domain/productCatalog.js","src/domain/xlsxLite.js","src/domain/supplyChain.js"],"relations":[{"platformId":"kuaimai","type":"reconciles","description":"销售文件校准月度事实，商品档案文件补齐快麦 API 缺少的规格字段。"},{"platformId":"cloudflare-d1","type":"stores-imports","description":"聚合销售结果和标准化商品目录分别通过内部 API 写入 D1。"}]},{"id":"taobao-open-platform","name":"淘宝开放平台","status":"planned","summary":"计划评估淘宝商品、订单或店铺数据能力，尚未接入。","capabilities":["商品数据","订单数据","店铺数据"],"businessQuestions":["淘宝数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],"keywords":["淘宝","天猫","Taobao","TOP","开放平台","店铺"],"codePaths":[],"envVars":[],"domains":["open.taobao.com"],"apiRoutes":[],"publicDocs":[{"label":"淘宝开放平台","url":"https://open.taobao.com/"}],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认订单口径是否已经由快麦覆盖。"}]},{"id":"pinduoduo-open-platform","name":"拼多多开放平台","status":"planned","summary":"计划评估拼多多商品、订单或店铺数据能力，尚未接入。","capabilities":["商品数据","订单数据","店铺数据"],"businessQuestions":["拼多多数据能否自动同步","应用权限和授权主体","与快麦数据是否重复"],"keywords":["拼多多","Pinduoduo","PDD","开放平台","店铺"],"codePaths":[],"envVars":[],"domains":["open.pinduoduo.com"],"apiRoutes":[],"publicDocs":[{"label":"拼多多开放平台","url":"https://open.pinduoduo.com/"}],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认订单口径是否已经由快麦覆盖。"}]},{"id":"xiaohongshu-open-platform","name":"小红书开放平台","status":"planned","summary":"计划评估小红书内容、电商或分享能力，尚未接入。","capabilities":["内容分享","电商数据","应用授权"],"businessQuestions":["能否发布或同步内容","电商数据权限","商家自研应用如何授权"],"keywords":["小红书","Xiaohongshu","RED","种草","开放平台","内容"],"codePaths":[],"envVars":[],"domains":["xiaohongshu.com","xiaohongshu.apifox.cn"],"apiRoutes":[],"publicDocs":[{"label":"小红书开放平台应用开发","url":"https://xiaohongshu.apifox.cn/doc-2810909"},{"label":"小红书分享开放平台","url":"https://agora.xiaohongshu.com/"}],"evidence":[],"relations":[{"platformId":"oceanengine-qianchuan","type":"content-to-advertising","description":"内容与投放协同时需区分自然内容平台和付费投放平台的数据口径。"}]},{"id":"ugreen-nas","name":"绿联 NAS / UGOS Pro","status":"planned","summary":"计划通过公司 Mac 的 SMB/WebDAV 挂载和只读索引器关联品牌内容素材；官方未提供 MCP Server，MCP 仅作为可选文件搜索入口。","capabilities":["SMB 文件访问","WebDAV 文件访问","Docker 应用","NAS 用户认证","素材目录索引"],"businessQuestions":["品牌素材目录如何只读索引","NAS 离线和文件移动如何恢复","AI 文件搜索是否需要可选 MCP"],"keywords":["绿联 NAS","UGREEN NAS","UGOS Pro","NAS","SMB","WebDAV","素材目录","文件索引"],"codePaths":[],"envVars":[],"domains":["developer.ugnas.com","ugnas.com"],"apiRoutes":[],"publicDocs":[{"label":"绿联云开发者平台","url":"https://developer.ugnas.com/"},{"label":"UGOS Pro Docker 应用开发","url":"https://developer.ugnas.com/en/doc/backend/quick-start/develop-docker-app.html"},{"label":"绿联 NAS WebDAV 指南","url":"https://ai.ugreen.com/blogs/how-to/access-ugreen-nas-files-via-webdav"}],"evidence":[],"relations":[{"platformId":"oceanengine-qianchuan","type":"asset-to-performance","description":"NAS 内容资产通过内容主键和素材 ID 与投放表现关联，不能直接以文件名猜测归因。"}]},{"id":"oceanengine-qianchuan","name":"巨量引擎 / 巨量千川","status":"planned","summary":"计划评估广告计划、素材和投放报表能力，尚未接入。","capabilities":["广告计划","素材管理","投放报表","商品库"],"businessQuestions":["千川投放数据能否自动同步","素材表现如何归因","账户权限如何申请"],"keywords":["巨量引擎","巨量千川","千川","Ocean Engine","广告投放","素材","开放平台"],"codePaths":[],"envVars":[],"domains":["open.oceanengine.com","qianchuan.jinritemai.com"],"apiRoutes":[],"publicDocs":[{"label":"巨量引擎商业开放平台","url":"https://open.oceanengine.com/labels"}],"evidence":[],"relations":[{"platformId":"xiaohongshu-open-platform","type":"cross-channel-content","description":"跨渠道素材分析需要区分平台内容与投放数据口径。"}]},{"id":"browser-market-collector","name":"浏览器市场采集器","status":"connected","summary":"公司 Mac 通过 Chrome 调试协议只读采集已登记、已确认的平台市场类目页面，并写入用户洞察标准事实。","capabilities":["工作日采集","已登记页面白名单","用户市场","商品市场","视频市场","直播市场","页面结构版本","登录失效停止","幂等批次"],"businessQuestions":["平台市场数据没有更新","页面要求重新登录","页面字段发生变化","类目尚未确认","采集器未连接","周末为什么未自动采集"],"keywords":["用户洞察","浏览器采集","市场","类目","竞品","Chrome","CDP"],"codePaths":["scripts/user-insights-collector/**","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/**","src/domain/userInsights.js","src/state/userInsightsApi.js","src/state/UserInsightsProvider.jsx","src/features/data-center/UserInsightsWorkspace.jsx","src/features/data-center/user-insights.css","docs/features/user-insights/**","docs/platform/apis/user-insights-v1.md","docs/platform/browser-market-collection.md","migrations/0005_user_insights.sql"],"envVars":[],"domains":[],"apiRoutes":["/api/platform/v1/user-insights","/api/platform/v1/user-insights/collector","/api/platform/v1/user-insights/ingest"],"publicDocs":[],"evidence":["scripts/user-insights-collector/","functions/api/platform/v1/user-insights.js","functions/api/platform/v1/user-insights/","src/domain/userInsights.js","src/state/userInsightsApi.js","src/state/UserInsightsProvider.jsx","src/features/data-center/UserInsightsWorkspace.jsx","docs/features/user-insights/","migrations/0005_user_insights.sql"],"relations":[{"platformId":"cloudflare-pages","type":"writes-through","description":"采集器只能通过受限 Pages Functions ingest 契约写入，不能直连 D1。"},{"platformId":"cloudflare-d1","type":"stores-standard-facts","description":"D1 只保存标准事实、规则、质量和审计，不保存完整页面、Cookie 或凭证。"}]},{"id":"lingsuan-ai-gateway","name":"灵算 AI 网关","status":"connected","summary":"为公司 AI 总助提供服务端 Responses 兼容模型调用；功能默认关闭，密钥只存在服务端 Secret。","capabilities":["Responses 流式生成","固定模型配置","原生 Function Calling 能力探测","服务端受控 Skill 路由","公司只读 Skills","合成连接测试","无留存请求参数","安全错误映射"],"businessQuestions":["AI 总助不可用","模型服务连接失败","Skill 调用失败","响应超时或限流","公司数据能否外发","密钥是否安全"],"keywords":["灵算","LingSuan","AI 总助","Responses API","Function Calling","Skills","LINGSUAN_API_KEY"],"codePaths":["functions/api/platform/v1/ai/**","src/domain/aiAssistant.js","src/state/aiAssistant*.js","src/features/ai-assistant/**","src/features/data-center/AiProviderSettings.jsx"],"envVars":["AI_ASSISTANT_ENABLED","LINGSUAN_API_KEY","LINGSUAN_ACTOR_AUTHORIZATION"],"domains":["lingsuan.top"],"apiRoutes":["/api/platform/v1/ai/status","/api/platform/v1/ai/provider","/api/platform/v1/ai/provider/test","/api/platform/v1/ai/chat"],"publicDocs":[{"label":"灵算 AI API Gateway","url":"https://lingsuan.top/"}],"evidence":["src/domain/aiAssistant.js","functions/api/platform/v1/ai/_shared/routed-skill-fallback.js","react-tests/ai-assistant-domain.test.mjs","tests/ai-skill-loop.test.mjs","migrations/0003_company_ai_assistant.sql","migrations/0004_company_ai_skills.sql"],"relations":[{"platformId":"cloudflare-pages","type":"called-by","description":"Pages Functions 在服务端调用 Provider，浏览器不接触密钥或公司上下文。"},{"platformId":"cloudflare-d1","type":"governed-by","description":"D1 保存 Provider 安全元数据、外发策略、并发租约和无内容审计。"}]},{"id":"douyin-ecommerce","name":"抖音电商","status":"planned","summary":"计划通过平台授权、网页导出或固定公司 Mac 的已登录页面采集店铺经营数据，尚未接入。","capabilities":["店铺订单","商品数据","经营报表","网页导出"],"businessQuestions":["抖音店铺如何授权","邮箱或手机号登录如何处理","验证码后如何恢复同步","与快麦订单是否重复"],"keywords":["抖音电商","抖店","Douyin Ecommerce","店铺后台","邮箱登录"],"codePaths":[],"envVars":[],"domains":[],"apiRoutes":[],"publicDocs":[],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需区分快麦聚合订单与抖音店铺原始经营数据。"},{"platformId":"oceanengine-qianchuan","type":"commerce-to-advertising","description":"店铺经营数据与巨量投放数据分别采集并通过标准维度关联。"}]},{"id":"kuaishou-ecosystem","name":"快手生态","status":"planned","summary":"计划接入快手小店和广告账户的经营与投放数据，尚未接入。","capabilities":["店铺订单","商品数据","经营报表","广告数据","网页导出"],"businessQuestions":["快手小店与广告账户如何区分","登录验证如何处理","经营和投放口径如何关联"],"keywords":["快手","快手小店","磁力引擎","Kuaishou","店铺后台"],"codePaths":[],"envVars":[],"domains":[],"apiRoutes":[],"publicDocs":[],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认快手订单是否已由快麦覆盖。"}]},{"id":"jd-jingmai","name":"京东 / 京麦","status":"planned","summary":"计划接入京东店铺和京麦后台的订单、商品与经营数据，尚未接入。","capabilities":["店铺订单","商品数据","经营报表","网页导出"],"businessQuestions":["京麦账号如何授权","扫码或设备验证如何处理","与快麦订单是否重复"],"keywords":["京东","京麦","JD","Jingmai","店铺后台"],"codePaths":[],"envVars":[],"domains":[],"apiRoutes":[],"publicDocs":[],"evidence":[],"relations":[{"platformId":"kuaimai","type":"possible-overlap","description":"接入前需确认京东订单是否已由快麦覆盖。"}]},{"id":"openai-responses","name":"OpenAI Responses API","status":"integrating","summary":"为电商店铺运营方案提供可选的服务端优化建议；未配置时明确降级为规则检查。","capabilities":["方案结构点评","问题与对策检查","监测指标建议"],"businessQuestions":["AI 点评不可用","模型响应超时","建议是否替代主管审批","输入是否包含敏感字段"],"keywords":["OpenAI","Responses API","AI 点评","智能建议","OPENAI_API_KEY"],"codePaths":["functions/api/ecommerce-operations/ai-review.js"],"envVars":["OPENAI_API_KEY","OPENAI_MODEL"],"domains":["api.openai.com","platform.openai.com"],"apiRoutes":["/api/ecommerce-operations/ai-review"],"publicDocs":[{"label":"OpenAI API 开发者快速入门","url":"https://platform.openai.com/docs/quickstart/make-your-first-api-request"}],"evidence":["functions/api/ecommerce-operations/ai-review.js"],"relations":[{"platformId":"cloudflare-pages","type":"called-by","description":"Pages Function 从服务端调用 Responses API，密钥不进入浏览器。"}]}]'),Ce={platforms:Re},Oe=["connected","integrating","planned","retired"],je=s=>String(s??"").replace(/\s+/g," ").trim().toLocaleLowerCase("zh-CN");function be(s,e=[]){const a=new Map((Array.isArray(e)?e:[]).filter(t=>t?.platformId).map(t=>[t.platformId,t]));return(s?.platforms||[]).map(t=>({...t,internal:a.get(t.id)||null}))}function xe(s,{query:e="",status:a="all"}={}){const t=je(e);return(s||[]).filter(l=>a!=="all"&&l.status!==a?!1:t?[l.id,l.name,l.summary,...l.capabilities||[],...l.businessQuestions||[],...l.keywords||[]].join(`
`).toLocaleLowerCase("zh-CN").includes(t):!0)}function ke(s){const e=Object.fromEntries(["all",...Oe].map(a=>[a,0]));for(const a of s||[])e.all+=1,Object.hasOwn(e,a.status)&&(e[a.status]+=1);return e}function ye(s,e){const a=new Map((s||[]).map(t=>[t.id,t]));return(e?.relations||[]).flatMap(t=>{const l=a.get(t.platformId);return l?[{...t,platform:l}]:[]})}function Le(s,{now:e=new Date,staleDays:a=180}={}){const t=Date.parse(`${s?.verifiedAt||""}T00:00:00Z`);return Number.isNaN(t)?!0:(e.getTime()-t)/864e5>a}const we="https://product-flow-system.pages.dev/api/platform/v1/integrations";function nn(s=""){return["localhost","127.0.0.1","::1"].includes(s)?we:"/api/platform/v1/integrations"}async function en(s){const e=await s.json().catch(()=>({}));if(!s.ok)throw new Error(e.message||`内部平台资料请求失败（HTTP ${s.status}）。`);return e}async function Ue({hostname:s="",fetchImpl:e=fetch}={}){try{const a=await e(nn(s),{credentials:"include"}),t=await en(a);return Array.isArray(t.profiles)?t.profiles:[]}catch(a){throw a?.message&&!/failed to fetch|networkerror/i.test(a.message)?a:new Error("无法连接内部平台资料服务。")}}async function Me(s,{hostname:e="",fetchImpl:a=fetch}={}){try{const t=await a(nn(e),{method:"PUT",credentials:"include",headers:{"content-type":"application/json"},body:JSON.stringify(s)});return(await en(t)).profile}catch(t){throw t?.message&&!/failed to fetch|networkerror/i.test(t.message)?t:new Error("无法连接内部平台资料服务。")}}const j=[{id:"all",label:"全部"},{id:"connected",label:"已连接"},{id:"integrating",label:"集成中"},{id:"planned",label:"计划中"},{id:"retired",label:"已停用"}],Ve={consoleUrl:"",accountSubject:"",resourceNamesText:"",environmentsText:"",owner:"",permissionGuide:"",runbook:"",verifiedAt:""};function Ge(s){return s?{consoleUrl:s.consoleUrl||"",accountSubject:s.accountSubject||"",resourceNamesText:(s.resourceNames||[]).join(`
`),environmentsText:(s.environments||[]).map(e=>[e.name,e.url,e.notes].join(" | ")).join(`
`),owner:s.owner||"",permissionGuide:s.permissionGuide||"",runbook:s.runbook||"",verifiedAt:s.verifiedAt||""}:Ve}function Fe(s,e){return{platformId:s,consoleUrl:e.consoleUrl,accountSubject:e.accountSubject,resourceNames:e.resourceNamesText.split(/\r?\n/).map(a=>a.trim()).filter(Boolean),environments:e.environmentsText.split(/\r?\n/).flatMap(a=>{const[t="",l="",...o]=a.split("|").map(u=>u.trim());return t?[{name:t,url:l,notes:o.join(" | ")}]:[]}),owner:e.owner,permissionGuide:e.permissionGuide,runbook:e.runbook,verifiedAt:e.verifiedAt}}function Ke({platform:s,saving:e,error:a,onCancel:t,onSave:l}){const[o,u]=d.useState(()=>Ge(s.internal)),p=(r,I)=>u(A=>({...A,[r]:I}));return n.jsxs("form",{className:"integration-profile-editor",onSubmit:r=>{r.preventDefault(),l(Fe(s.id,o))},children:[n.jsxs("div",{className:"integration-editor-heading",children:[n.jsxs("div",{children:[n.jsx("strong",{children:"维护内部资料"}),n.jsx("p",{children:"只填写入口、主体、资源和责任信息；凭据必须保存在密钥管理系统。"})]}),n.jsx("button",{className:"icon-action",type:"button","aria-label":"关闭编辑",onClick:t,disabled:e,children:n.jsx(V,{size:16,"aria-hidden":"true"})})]}),n.jsxs("div",{className:"integration-form-grid",children:[n.jsxs("label",{children:[n.jsx("span",{children:"内部控制台 URL"}),n.jsx("input",{type:"url",value:o.consoleUrl,onChange:r=>p("consoleUrl",r.target.value),placeholder:"https://"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"账号主体"}),n.jsx("input",{value:o.accountSubject,onChange:r=>p("accountSubject",r.target.value),placeholder:"公司或业务主体"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"负责人"}),n.jsx("input",{value:o.owner,onChange:r=>p("owner",r.target.value),placeholder:"姓名或岗位"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"最近验证日期"}),n.jsx("input",{type:"date",value:o.verifiedAt,onChange:r=>p("verifiedAt",r.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"应用 / 实例 / 店铺名称"}),n.jsx("textarea",{rows:"3",value:o.resourceNamesText,onChange:r=>p("resourceNamesText",r.target.value),placeholder:"每行一个名称"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"环境"}),n.jsx("textarea",{rows:"3",value:o.environmentsText,onChange:r=>p("environmentsText",r.target.value),placeholder:"生产 | https://example.com/ | 钉钉工作台"}),n.jsx("small",{children:"每行格式：环境名 | HTTPS URL | 说明"})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"权限申请路径"}),n.jsx("textarea",{rows:"2",value:o.permissionGuide,onChange:r=>p("permissionGuide",r.target.value)})]}),n.jsxs("label",{className:"span-2",children:[n.jsx("span",{children:"内部运行手册"}),n.jsx("textarea",{rows:"2",value:o.runbook,onChange:r=>p("runbook",r.target.value),placeholder:"知识库位置或简短操作说明"})]})]}),a?n.jsx("p",{className:"integration-form-error",role:"alert",children:a}):null,n.jsxs("div",{className:"integration-editor-actions",children:[n.jsx("button",{className:"btn",type:"button",onClick:t,disabled:e,children:"取消"}),n.jsx("button",{className:"btn primary",type:"submit",disabled:e,children:e?"正在保存…":"保存内部资料"})]})]})}function Be({platform:s,loading:e}){if(e)return n.jsxs("div",{className:"integration-profile-loading","aria-busy":"true",children:[n.jsx("span",{}),n.jsx("span",{}),n.jsx("span",{}),n.jsx("small",{children:"正在读取内部资料…"})]});const a=s.internal;return a?n.jsxs("div",{className:"integration-profile-content",children:[Le(a)?n.jsxs("p",{className:"integration-stale",children:[n.jsx(O,{size:15,"aria-hidden":"true"}),"资料超过 180 天未验证，请联系负责人复核。"]}):null,n.jsxs("dl",{children:[n.jsxs("div",{children:[n.jsx("dt",{children:"账号主体"}),n.jsx("dd",{children:a.accountSubject||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"负责人"}),n.jsx("dd",{children:a.owner||"未填写"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"最近验证"}),n.jsx("dd",{children:a.verifiedAt||"未验证"})]}),n.jsxs("div",{children:[n.jsx("dt",{children:"维护人"}),n.jsx("dd",{children:a.updatedBy||"未知"})]})]}),a.consoleUrl?n.jsxs("a",{className:"integration-console-link",href:a.consoleUrl,target:"_blank",rel:"noreferrer",children:["打开内部控制台 ",n.jsx(Q,{size:14,"aria-hidden":"true"})]}):null,a.resourceNames?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"应用 / 实例 / 店铺"}),n.jsx("ul",{children:a.resourceNames.map(t=>n.jsx("li",{children:t},t))})]}):null,a.environments?.length?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"环境"}),n.jsx("ul",{children:a.environments.map(t=>n.jsxs("li",{children:[n.jsx("b",{children:t.name}),t.url?n.jsx("a",{href:t.url,target:"_blank",rel:"noreferrer",children:t.url}):null,t.notes?n.jsx("span",{children:t.notes}):null]},`${t.name}-${t.url}`))})]}):null,a.permissionGuide?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"权限申请路径"}),n.jsx("p",{children:a.permissionGuide})]}):null,a.runbook?n.jsxs("div",{className:"integration-internal-block",children:[n.jsx("strong",{children:"内部运行手册"}),n.jsx("p",{children:a.runbook})]}):null]}):n.jsxs("div",{className:"integration-profile-empty",children:[n.jsx(z,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料尚未维护"}),n.jsx("p",{children:"平台管理员可补充控制台、账号主体、负责人和运行手册。"})]})]})}function Ye({sessionUser:s}){const[e,a]=d.useState([]),[t,l]=d.useState("loading"),[o,u]=d.useState(""),[p,r]=d.useState(""),[I,A]=d.useState("all"),[f,S]=d.useState("dingtalk"),[D,P]=d.useState(!1),[T,c]=d.useState(!1),[m,v]=d.useState(""),[R,C]=d.useState("");d.useEffect(()=>{let i=!0;return Ue({hostname:window.location.hostname}).then(h=>{i&&(a(h),l("ready"))}).catch(h=>{i&&(u(h?.message||"内部资料暂不可用。"),l("error"))}),()=>{i=!1}},[]);const E=d.useMemo(()=>be(Ce,e),[e]),g=d.useMemo(()=>ke(E),[E]),N=d.useMemo(()=>xe(E,{query:p,status:I}),[E,p,I]),_=N.find(i=>i.id===f)||N[0]||null,F=d.useMemo(()=>ye(E,_),[E,_]),sn=q(s)&&s?.role!=="readonly",an=i=>{S(i),P(!1),v(""),C("")},tn=async i=>{c(!0),v(""),C("");try{const h=await Me(i,{hostname:window.location.hostname});a(on=>[...on.filter(rn=>rn.platformId!==h.platformId),h]),P(!1),C("内部资料已保存。公开注册表未被修改。")}catch(h){v(h?.message||"内部平台资料保存失败。")}finally{c(!1)}};return n.jsxs("section",{className:"integration-map","aria-label":"外部平台地图",children:[t==="error"?n.jsxs("div",{className:"integration-degraded",role:"status",children:[n.jsx(O,{size:17,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:"内部资料暂不可用"}),n.jsxs("p",{children:[o," 公开平台资料仍可正常查看。"]})]})]}):null,n.jsxs("div",{className:"integration-map-toolbar",children:[n.jsxs("label",{className:"integration-map-search",children:[n.jsx(y,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索平台、能力或问题"}),n.jsx("input",{type:"search",value:p,onChange:i=>r(i.target.value),placeholder:"搜索平台、能力或问题"}),p?n.jsx("button",{type:"button","aria-label":"清除平台搜索",onClick:()=>r(""),children:n.jsx(V,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"integration-status-filters","aria-label":"平台状态筛选",children:j.map(i=>n.jsxs("button",{type:"button","aria-pressed":I===i.id,className:I===i.id?"active":"",onClick:()=>A(i.id),children:[i.label,n.jsx("span",{children:g[i.id]})]},i.id))})]}),N.length?n.jsxs("div",{className:"integration-map-workspace",children:[n.jsx("nav",{className:"integration-platform-list","aria-label":"外部平台",children:N.map(i=>n.jsxs("button",{type:"button",className:_?.id===i.id?"active":"","aria-current":_?.id===i.id?"true":void 0,onClick:()=>an(i.id),children:[n.jsx("span",{className:`integration-status-dot ${i.status}`,"aria-hidden":"true"}),n.jsxs("span",{children:[n.jsx("strong",{children:i.name}),n.jsx("small",{children:i.capabilities.slice(0,2).join(" · ")})]}),n.jsx("em",{className:`integration-status-label ${i.status}`,children:j.find(h=>h.id===i.status)?.label})]},i.id))}),n.jsxs("div",{className:"integration-platform-detail",children:[n.jsxs("header",{className:"integration-detail-header",children:[n.jsxs("div",{children:[n.jsxs("div",{className:"integration-detail-title",children:[n.jsx("h2",{children:_.name}),n.jsx("span",{className:`integration-status-label ${_.status}`,children:j.find(i=>i.id===_.status)?.label})]}),n.jsx("p",{children:_.summary})]}),sn&&!D?n.jsxs("button",{className:"btn compact",type:"button",onClick:()=>{P(!0),v("")},children:[n.jsx(mn,{size:14,"aria-hidden":"true"}),"维护内部资料"]}):null]}),R?n.jsxs("p",{className:"integration-save-success",role:"status",children:[n.jsx(_n,{size:15,"aria-hidden":"true"}),R]}):null,n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"能力与常见问题"}),n.jsx("div",{className:"integration-capabilities",children:_.capabilities.map(i=>n.jsx("span",{children:i},i))}),n.jsx("ul",{className:"integration-question-list",children:_.businessQuestions.map(i=>n.jsx("li",{children:i},i))})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"关联关系"}),F.length?n.jsx("ul",{className:"integration-relation-list",children:F.map(i=>n.jsxs("li",{children:[n.jsx(In,{size:15,"aria-hidden":"true"}),n.jsxs("div",{children:[n.jsx("strong",{children:i.platform.name}),n.jsx("p",{children:i.description})]}),n.jsx("span",{children:j.find(h=>h.id===i.platform.status)?.label})]},`${i.platform.id}-${i.type}`))}):n.jsx("p",{children:"当前没有登记的一层关联平台。"})]}),n.jsxs("section",{className:"integration-detail-section",children:[n.jsx("h3",{children:"官方公开文档"}),_.publicDocs.length?n.jsx("div",{className:"integration-public-links",children:_.publicDocs.map(i=>n.jsxs("a",{href:i.url,target:"_blank",rel:"noreferrer",children:[i.label,n.jsx(Q,{size:14,"aria-hidden":"true"})]},i.url))}):n.jsx("p",{children:"该能力是内部文件导入边界，没有独立的外部官方文档。"})]}),n.jsxs("section",{className:"integration-detail-section integration-private-section",children:[n.jsxs("div",{className:"integration-section-heading",children:[n.jsx("h3",{children:"公司内部资料"}),n.jsx("span",{children:"登录后可见"})]}),D?n.jsx(Ke,{platform:_,saving:T,error:m,onCancel:()=>{P(!1),v("")},onSave:tn},_.id):n.jsx(Be,{platform:_,loading:t==="loading"})]})]})]}):n.jsxs("div",{className:"integration-map-empty",children:[n.jsx(y,{size:22,"aria-hidden":"true"}),n.jsx("strong",{children:"没有匹配的平台"}),n.jsx("p",{children:"换一个关键词，或清除状态筛选查看全部平台。"}),n.jsx("button",{className:"btn",type:"button",onClick:()=>{r(""),A("all")},children:"查看全部平台"})]})]})}async function x(s,e){const a=await fetch(s,e),t=await a.json().catch(()=>({}));if(!a.ok){const l=new Error(t.message||`环境状态请求失败（HTTP ${a.status}）。`);throw l.code=t.error?.code||"ENVIRONMENT_REQUEST_FAILED",l}return t}function We(){return x("/api/platform/v1/environment-readiness")}function He({reason:s,confirmation:e}){return x("/api/platform/v1/production-write-session",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({reason:s,confirmation:e})})}function qe(){return x("/api/platform/v1/production-write-session",{method:"DELETE"})}function Qe({auditId:s,confirmation:e}){return x("/api/platform/v1/production-data/rollback",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({auditId:s,confirmation:e})})}const ze={development:"本地测试",preview:"预览环境",production:"生产环境"},$e={ready:"已就绪",warning:"有警告",blocked:"阻断"},Je={PRODUCT_FLOW_DB:"公司数据库连接",PLATFORM_CREDENTIAL_MASTER_KEY:"平台连接安全保护",DINGTALK_APP_KEY:"钉钉应用凭证",DINGTALK_APP_SECRET:"钉钉应用密钥",KUAIMAI_APP_KEY:"快麦应用凭证",KUAIMAI_APP_SECRET:"快麦应用密钥",KUAIMAI_ACCESS_TOKEN:"快麦访问授权"};function Xe(s){return Je[s]||(String(s).includes("_")?"系统运行配置":s)}function Ze({status:s}){return s==="ready"?n.jsx(J,{size:17,"aria-hidden":"true"}):s==="warning"?n.jsx(O,{size:17,"aria-hidden":"true"}):n.jsx($,{size:17,"aria-hidden":"true"})}function ns(){return n.jsxs("div",{className:"environment-loading","aria-busy":"true","aria-label":"正在检查环境状态",children:[n.jsx("span",{}),n.jsx("span",{}),n.jsx("span",{}),n.jsx("p",{children:"正在核对环境变量、数据库绑定和平台能力…"})]})}function es({capabilities:s=[]}){return n.jsxs("section",{className:"environment-section","aria-labelledby":"environment-capability-title",children:[n.jsx("div",{className:"environment-section-heading",children:n.jsxs("div",{children:[n.jsx("h2",{id:"environment-capability-title",children:"能力检查"}),n.jsx("p",{children:"只展示配置是否存在，不读取或显示密钥内容。"})]})}),n.jsx("div",{className:"environment-capability-grid",children:s.map(e=>n.jsxs("article",{className:`environment-capability ${e.status}`,children:[n.jsxs("div",{className:"environment-capability-heading",children:[n.jsx("span",{className:"environment-status-icon",children:n.jsx(Ze,{status:e.status})}),n.jsxs("div",{children:[n.jsx("h3",{children:e.name}),n.jsx("p",{children:e.description})]}),n.jsx("strong",{children:$e[e.status]||e.status})]}),e.missing?.length?n.jsxs("div",{className:"environment-missing",children:[n.jsx("span",{children:"需要处理"}),n.jsx("ul",{children:e.missing.map(a=>n.jsx("li",{title:a,children:Xe(a)},a))}),e.platforms?.some(a=>["dingtalk","kuaimai"].includes(a))?n.jsx("a",{className:"btn compact",href:"#/data-connections",children:"前往平台连接"}):null]}):n.jsxs("p",{className:"environment-complete",children:[n.jsx(fn,{size:15,"aria-hidden":"true"}),"必要配置与表结构完整"]})]},e.id))})]})}function ss({audits:s=[],canRollback:e,busy:a,onRollback:t}){const[l,o]=d.useState(""),[u,p]=d.useState("");return s.length?n.jsx("div",{className:"environment-audit-list",children:s.map(r=>{const I=l===r.id,A=e&&r.status==="succeeded"&&r.snapshot_id;return n.jsxs("article",{className:"environment-audit-row",children:[n.jsxs("div",{children:[n.jsx("strong",{children:r.action==="rollback"?"回滚生产数据":"修改生产数据"}),n.jsx("p",{children:r.reason||"未记录原因"}),n.jsxs("small",{children:[r.name||"未知账号"," · ",new Date(r.created_at).toLocaleString("zh-CN")]})]}),n.jsx("span",{className:`environment-audit-status ${r.status}`,children:r.status==="succeeded"?"成功":r.status}),A?n.jsxs("button",{type:"button",className:"btn compact",onClick:()=>{o(I?"":r.id),p("")},disabled:a,children:[n.jsx(hn,{size:14}),"回滚"]}):null,I?n.jsxs("div",{className:"environment-rollback-confirm",children:[n.jsxs("label",{children:[n.jsx("span",{children:"输入“修改线上真实数据”确认回滚"}),n.jsx("input",{value:u,onChange:f=>p(f.target.value)})]}),n.jsx("button",{type:"button",className:"btn danger compact",disabled:a||u!=="修改线上真实数据",onClick:()=>t(r.id,u),children:"确认回滚"})]}):null]},r.id)})}):n.jsx("p",{className:"environment-audit-empty",children:"还没有跨环境生产写入记录。"})}function as({sessionUser:s}){const[e,a]=d.useState(null),[t,l]=d.useState("loading"),[o,u]=d.useState(""),[p,r]=d.useState(!1),[I,A]=d.useState(""),[f,S]=d.useState(""),[D,P]=d.useState(""),T=d.useCallback(async()=>{l("loading"),u("");try{a(await We()),l("ready")}catch(g){u(g?.message||"环境状态暂时无法读取。"),l("error")}},[]);d.useEffect(()=>{T()},[T]);const c=e?.dataAccess||{},m=e?.environment==="development",v=q(s)&&s?.role!=="readonly",R=m&&v&&c.configured,C=d.useMemo(()=>c.expiresAt?Math.max(0,Math.ceil((Date.parse(c.expiresAt)-Date.now())/6e4)):0,[c.expiresAt]),E=async(g,N)=>{r(!0),u(""),A("");try{await g(),A(N),await T()}catch(_){u(_?.message||"操作失败，请重试。")}finally{r(!1)}};return t==="loading"&&!e?n.jsx(ns,{}):t==="error"&&!e?n.jsxs("div",{className:"environment-load-error",role:"alert",children:[n.jsx($,{size:20}),n.jsxs("div",{children:[n.jsx("strong",{children:"环境状态暂不可用"}),n.jsx("p",{children:o}),n.jsx("button",{type:"button",className:"btn",onClick:T,children:"重新检查"})]})]}):n.jsxs("section",{className:"environment-readiness","aria-label":"环境与生产数据",children:[n.jsxs("header",{className:`environment-overview ${e.ready?"ready":"blocked"}`,children:[n.jsx("div",{className:"environment-overview-icon",children:e.ready?n.jsx(J,{size:22}):n.jsx(O,{size:22})}),n.jsxs("div",{children:[n.jsx("span",{children:ze[e.environment]||e.environment}),n.jsx("h2",{children:e.ready?"生产环境配置完整":"生产环境缺少必要配置"}),n.jsx("p",{children:e.ready?"数据库、钉钉和生产数据控制能力已通过必要检查。":"存在阻断项，不能完成发布验收；请按下方缺少项补齐。"})]}),n.jsxs("button",{type:"button",className:"btn compact",onClick:T,disabled:p||t==="loading",children:[n.jsx(An,{size:14}),"重新检查"]})]}),c.unlocked?n.jsxs("div",{className:"production-write-active",role:"alert",children:[n.jsx(K,{size:19}),n.jsxs("div",{children:[n.jsx("strong",{children:"正在修改线上真实数据"}),n.jsxs("p",{children:["剩余约 ",C," 分钟 · 原因：",c.reason]})]}),n.jsx("button",{type:"button",className:"btn danger compact",disabled:p,onClick:()=>E(qe,"生产写入已锁定。"),children:"立即锁定"})]}):null,o?n.jsx("p",{className:"environment-inline-error",role:"alert",children:o}):null,I?n.jsx("p",{className:"environment-inline-success",role:"status",children:I}):null,n.jsx(es,{capabilities:e.capabilities}),m?n.jsxs("section",{className:"environment-section production-access-section","aria-labelledby":"production-access-title",children:[n.jsxs("div",{className:"environment-section-heading",children:[n.jsxs("div",{children:[n.jsx("h2",{id:"production-access-title",children:"生产数据访问"}),n.jsx("p",{children:"本地默认实时读取生产数据，写入必须由指定最高权限账号短时解锁。"})]}),n.jsxs("span",{className:`environment-access-badge ${c.configured?"configured":"missing"}`,children:[n.jsx(z,{size:14}),c.configured?"已连接生产数据":"未配置个人令牌"]})]}),c.configured?null:n.jsxs("div",{className:"environment-access-help",children:[n.jsx(gn,{size:18}),n.jsxs("div",{children:[n.jsx("strong",{children:"当前保持本地数据模式"}),n.jsxs("p",{children:["在被忽略的 ",n.jsx("code",{children:".env"})," 中配置 ",n.jsx("code",{children:"PRODUCTION_DATA_ACCESS_TOKEN"})," 后重启本地服务。"]})]})]}),c.configured&&!v?n.jsx("p",{className:"environment-no-permission",children:"当前账号可以查看真实数据，但没有生产写入解锁权限。"}):null,R&&!c.unlocked?n.jsxs("form",{className:"production-unlock-form",onSubmit:g=>{g.preventDefault(),E(()=>He({reason:f,confirmation:D}),"生产写入已解锁 15 分钟。")},children:[n.jsxs("div",{className:"production-unlock-warning",children:[n.jsx(O,{size:18}),n.jsx("p",{children:"接下来的测试修改会直接写入线上数据库，并记录审计。钉钉等外部真实操作仍保持禁止。"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"修改原因"}),n.jsx("input",{value:f,onChange:g=>S(g.target.value),minLength:"4",maxLength:"200",placeholder:"例如：修正测试中发现的产品状态"})]}),n.jsxs("label",{children:[n.jsx("span",{children:"输入“修改线上真实数据”确认"}),n.jsx("input",{value:D,onChange:g=>P(g.target.value)})]}),n.jsxs("button",{type:"submit",className:"btn danger",disabled:p||f.trim().length<4||D!=="修改线上真实数据",children:[n.jsx(K,{size:15}),"解锁 15 分钟生产写入"]})]}):null,n.jsxs("div",{className:"environment-audit-heading",children:[n.jsx("h3",{children:"最近生产数据审计"}),n.jsx("span",{children:"最多显示 30 条"})]}),n.jsx(ss,{audits:e.audit||[],canRollback:R&&c.unlocked,busy:p,onRollback:(g,N)=>E(()=>Qe({auditId:g,confirmation:N}),"生产数据已回滚，并生成新的审计记录。")})]}):null]})}const ts=Object.fromEntries(X.map(s=>[s.id,s.label])),H={guide:"使用说明",product:"产品说明",design:"设计书",specification:"设计规格",platform:"平台能力"},is=s=>Object.entries(ts).map(([e,a])=>({category:e,label:a,documents:s.filter(t=>t.category===e)})).filter(e=>e.documents.length);function ps({selectedSlug:s,onSelectDocument:e,sessionUser:a}){const[t,l]=d.useState(""),o=Pn(k,s,U),[u,p]=d.useState(()=>o?.category??"handbook"),r=d.useMemo(()=>Dn(k,{query:t,category:u}),[u,t]),I=d.useMemo(()=>is(r),[r]),A=o?.slug==="platform/external-platform-map",f=o?.slug==="platform/environment-readiness",S=A||f,D=d.useMemo(()=>Tn(o?.content),[o]);d.useEffect(()=>{s&&o?.category&&p(o.category)},[o?.category,s]);const P=c=>{if(p(c),o?.category!==c){const m=k.find(v=>v.category===c);m&&e?.(m.slug)}},T=(c,m)=>{c.preventDefault(),document.getElementById(m)?.scrollIntoView({behavior:"smooth",block:"start"})};return n.jsxs("section",{className:"page handbook-page",children:[n.jsx(un,{title:"说明书",description:"公司的工作方法、产品定义、设计决策与共享平台能力，以仓库文档为准。"}),n.jsxs("div",{className:"handbook-tools",role:"search",children:[n.jsxs("label",{className:"handbook-search",children:[n.jsx(y,{size:16,"aria-hidden":"true"}),n.jsx("span",{className:"sr-only",children:"搜索说明书"}),n.jsx("input",{type:"search",value:t,onChange:c=>l(c.target.value),placeholder:"搜索说明书"}),t?n.jsx("button",{type:"button","aria-label":"清除搜索",onClick:()=>l(""),children:n.jsx(V,{size:15,"aria-hidden":"true"})}):null]}),n.jsx("div",{className:"handbook-filters","aria-label":"说明书分类",children:X.map(c=>n.jsx("button",{type:"button",className:u===c.id?"active":"","aria-pressed":u===c.id,onClick:()=>P(c.id),children:c.label},c.id))})]}),r.length&&o?n.jsxs("div",{className:`handbook-workspace${A?" platform-map-open":""}${f?" environment-readiness-open":""}`,children:[n.jsx("nav",{className:"handbook-catalog","aria-label":"说明书目录",children:I.map(c=>n.jsxs("section",{className:"handbook-catalog-group","data-category":c.category,children:[n.jsx("h2",{children:c.label}),n.jsx("div",{className:"handbook-document-list",children:c.documents.map(m=>n.jsxs("button",{type:"button",className:o.slug===m.slug?"active":"","aria-current":o.slug===m.slug?"page":void 0,onClick:()=>e?.(m.slug),children:[n.jsx("strong",{children:m.title}),n.jsx("small",{children:H[m.kind]??m.kind})]},m.slug))})]},c.category))}),n.jsxs("article",{className:`handbook-article${A?" handbook-article-platform-map":""}${f?" handbook-article-environment-readiness":""}`,children:[n.jsxs("header",{className:"handbook-document-header",children:[n.jsxs("div",{className:"handbook-document-kind",children:[n.jsx(B,{size:15,"aria-hidden":"true"}),H[o.kind]??o.kind]}),n.jsx("h1",{children:o.title}),n.jsx("p",{children:o.summary}),n.jsxs("time",{dateTime:o.updatedAt,children:["更新于 ",o.updatedAt]})]}),A?n.jsx(Ye,{sessionUser:a}):f?n.jsx(as,{sessionUser:a}):n.jsx(Rn,{content:Nn(o.content)})]}),S?null:n.jsxs("aside",{className:"handbook-toc","aria-label":"本页目录",children:[n.jsx("strong",{children:"本页目录"}),D.length?n.jsx("ol",{children:D.map(c=>n.jsx("li",{className:`level-${c.level}`,children:n.jsx("a",{href:`#${c.id}`,onClick:m=>T(m,c.id),children:c.title})},`${c.id}-${c.level}`))}):n.jsx("small",{children:"本页没有分节标题"})]})]}):n.jsxs("div",{className:"handbook-empty",children:[n.jsx(B,{size:24,"aria-hidden":"true"}),n.jsx("strong",{children:"没有找到匹配的说明"}),n.jsx("span",{children:"换一个关键词，或返回使用手册查看现有文档。"}),n.jsx("button",{type:"button",className:"btn",onClick:()=>{l(""),P("handbook")},children:"返回使用手册"})]})]})}export{ps as default};
