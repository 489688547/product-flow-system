...
- 本机执行器只监听 \`127.0.0.1\`，固定校验扩展 ID 与随机配对密钥；runner token 和配对密钥分别存在 macOS Keychain。插件只接收 provider/resource/businessDate/jobId，不接收远程 URL、选择器、脚本或凭据。
